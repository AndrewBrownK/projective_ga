...
impl UnitizedCenterNormSquared for AntiCircleRotor {
    ...
    fn unitized_center_norm_squared(self) -> f32 {
        ...
        (self[e41] * self[e41] * self[e23] * self[e23])
            + (self[e41] * self[e41] * self[e31] * self[e31])
            + (self[e41] * self[e41] * self[e12] * self[e12])
...
impl UnitizedCenterNormSquared for Dipole {
    ...
    fn unitized_center_norm_squared(self) -> f32 {
        use crate::elements::*;
        (self[e41] * self[e41] * self[e23] * self[e23]) + (self[e41] * self[e41] * self[e31] * self[e31]) + (self[e41] * self[e41] * self[e12] * self[e12])
    }
}
