...
impl BulkExpansion<VersorEven> for AntiCircleRotor {
    ...
    fn bulk_expansion(self, other: VersorEven) -> Self::Output {
        ...
        VersorOdd::from_groups(
            // e41, e42, e43, scalar
            ((right_dual_g0_xyz * Simd32x3::from(self[scalar])) + (Simd32x3::from(right_dual_g0_w) * self.group0())).with_w(right_dual_g0_w * self[scalar]),
            // e23, e31, e12, e45
...
impl BulkExpansion<AntiPlane> for AntiDipoleInversion {
    ...
    fn bulk_expansion(self, other: AntiPlane) -> Self::Output {
        ...
        AntiScalar::from_groups(
            // e12345
            (right_dual_g0_xyz[0] * self[e1]) + (right_dual_g0_xyz[1] * self[e2]) + (right_dual_g0_xyz[2] * self[e3]) - (self[e4] * other[e5]),
        )
    }
}
...
impl BulkExpansion<RoundPoint> for AntiDipoleInversion {
    ...
    fn bulk_expansion(self, other: RoundPoint) -> Self::Output {
        ...
        AntiScalar::from_groups(
            // e12345
            (right_dual_g0_xyz[0] * self[e1]) + (right_dual_g0_xyz[1] * self[e2]) + (right_dual_g0_xyz[2] * self[e3]) - (self[e4] * other[e5]) - (self[e5] * other[e4]),
        )
    }
}
...
impl BulkExpansion<Motor> for AntiLine {
    ...
    fn bulk_expansion(self, other: Motor) -> Self::Output {
        ...
        AntiMotor::from_groups(
            ...
            // e15, e25, e35, e3215
            (Simd32x3::from(right_dual_g0_w) * self.group1()).with_w(
...
impl BulkExpansion<Motor> for AntiMotor {
    ...
    fn bulk_expansion(self, other: Motor) -> Self::Output {
        ...
        AntiMotor::from_groups(
            // e23, e31, e12, scalar
            ((right_dual_g0_xyz * Simd32x3::from(self[scalar])) + (Simd32x3::from(right_dual_g0_w) * self.group0().xyz())).with_w(right_dual_g0_w * self[scalar]),
            // e15, e25, e35, e3215
            (right_dual_g1 * Simd32x4::from(self[scalar]))
                + (Simd32x4::from(right_dual_g0_w) * self.group1())
...
impl BulkExpansion<CircleRotor> for Circle {
    ...
    fn bulk_expansion(self, other: CircleRotor) -> Self::Output {
        ...
        CircleRotor::from_groups(
            ...
            // e235, e315, e125, e12345
            (Simd32x3::from(right_dual_g2_w) * self.group2()).with_w(
...
impl BulkExpansion<Motor> for Circle {
    ...
    fn bulk_expansion(self, other: Motor) -> Self::Output {
        ...
        CircleRotor::from_groups(
            ...
            Simd32x4::from(right_dual_g0_w) * self.group1(),
            // e235, e315, e125, e12345
            (Simd32x3::from(right_dual_g0_w) * self.group2()).with_w(
...
impl BulkExpansion<CircleRotor> for Line {
    ...
    fn bulk_expansion(self, other: CircleRotor) -> Self::Output {
        ...
        Motor::from_groups(
            // e415, e425, e435, e12345
            (Simd32x3::from(right_dual_g2_w) * self.group0()).with_w(
                -(right_dual_g1_xyz[0] * self[e415])
                    - (right_dual_g1_xyz[1] * self[e425])
                    - (right_dual_g1_xyz[2] * self[e435])
                    - (other[e423] * self[e235])
...
impl BulkExpansion<VersorEven> for Line {
    ...
    fn bulk_expansion(self, other: VersorEven) -> Self::Output {
        ...
        Motor::from_groups(
            // e415, e425, e435, e12345
            (Simd32x3::from(right_dual_g0_w) * self.group0()).with_w(
                -(right_dual_g0_xyz[0] * self[e235])
                    - (right_dual_g0_xyz[1] * self[e315])
                    - (right_dual_g0_xyz[2] * self[e125])
                    - (right_dual_g1_xyz[0] * self[e415])
...
impl BulkExpansion<AntiDipoleInversion> for MultiVector {
    ...
    fn bulk_expansion(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            0.0,
            // e15, e25, e35, e45
            Simd32x4::from(self[scalar]) * right_dual_g2_xyz.with_w(right_dual_g1_w),
            // e41, e42, e43
            Simd32x3::from(self[scalar]) * other.group0(),
            // e23, e31, e12
...
impl BulkExpansion<Motor> for MultiVector {
    ...
    fn bulk_expansion(self, other: Motor) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e15, e25, e35, e45
            ((right_dual_g1_xyz * Simd32x3::from(self[scalar])) + (Simd32x3::from(right_dual_g0[3]) * self.group3().xyz())).with_w(right_dual_g0[3] * self[e45]),
            // e41, e42, e43
            ...
            // e235, e315, e125
            (Simd32x3::from(right_dual_g0[3]) * self.group8()) + (Simd32x3::from(self[e5]) * right_dual_g0.xyz()) + (right_dual_g1_xyz.zxy() * self.group1().yzx())
                - (right_dual_g1_xyz.yzx() * self.group1().zxy()),
            // e4235, e4315, e4125, e3215
...
impl BulkExpansion<AntiFlatPoint> for RoundPoint {
    ...
    fn bulk_expansion(self, other: AntiFlatPoint) -> Self::Output {
        ...
        Line::from_groups(
            // e415, e425, e435
            (right_dual_g0_xyz * Simd32x3::from(self[e4])) + (Simd32x3::from(other[e321]) * self.group0().xyz()),
            // e235, e315, e125
            (right_dual_g0_xyz.zxy() * self.group0().yzx()) - (right_dual_g0_xyz.yzx() * self.group0().zxy()),
        )
    }
...
impl BulkExpansion<MultiVector> for VersorEven {
    ...
    fn bulk_expansion(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x2::from([
                0.0,
                (right_dual_g0[0] * self[e12345]) + (right_dual_g9_xyz[0] * self[e1]) + (right_dual_g9_xyz[1] * self[e2]) + (right_dual_g9_xyz[2] * self[e3])
                    - (right_dual_g3_w * self[e321])
                    - (right_dual_g5[0] * self[e415])
                    - (right_dual_g5[1] * self[e425])
                    - (right_dual_g5[2] * self[e435])
