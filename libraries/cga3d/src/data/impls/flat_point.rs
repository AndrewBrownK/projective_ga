...
impl std::ops::Sub<AntiCircleRotor> for FlatPoint {
    ...
    fn sub(self, other: AntiCircleRotor) -> Self::Output {
        ...
        AntiCircleRotor::from_groups(
            ...
            // e15, e25, e35, scalar
            (self.group0().xy() - other.group2().xy()).with_zw(self[e35] - other[e35], other[scalar] * -1.0),
        )
    }
}
...
impl std::ops::Sub<Scalar> for FlatPoint {
    ...
    fn sub(self, other: Scalar) -> Self::Output {
        ...
        AntiCircleRotor::from_groups(
            ...
            Simd32x3::from(0.0).with_w(self[e45]),
            // e15, e25, e35, scalar
            self.group0().xyz().with_w(other[scalar] * -1.0),
        )
    }
}
...
impl TryFrom<AntiCircleRotor> for FlatPoint {
    ...
    fn try_from(anti_circle_rotor: AntiCircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(FlatPoint::from_groups(/* e15, e25, e35, e45 */ anti_circle_rotor.group2().xyz().with_w(anti_circle_rotor[e45])))
    }
}
...
impl TryFrom<DipoleInversion> for FlatPoint {
    ...
    fn try_from(dipole_inversion: DipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(FlatPoint::from_groups(/* e15, e25, e35, e45 */ dipole_inversion.group2().xyz().with_w(dipole_inversion[e45])))
    }
}
...
impl TryFrom<MultiVector> for FlatPoint {
    ...
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        Ok(FlatPoint::from_groups(/* e15, e25, e35, e45 */ multi_vector.group3()))
    }
}
...
impl TryFrom<VersorOdd> for FlatPoint {
    ...
    fn try_from(versor_odd: VersorOdd) -> Result<Self, Self::Error> {
        ...
        Ok(FlatPoint::from_groups(/* e15, e25, e35, e45 */ versor_odd.group2().xyz().with_w(versor_odd[e45])))
    }
}
