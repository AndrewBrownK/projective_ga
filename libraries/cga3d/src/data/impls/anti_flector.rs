...
impl std::ops::Add<RoundPoint> for AntiFlector {
    ...
    fn add(self, other: RoundPoint) -> Self::Output {
        ...
        AntiDipoleInversion::from_groups(
            ...
            // e1, e2, e3, e5
            self.group1() + Simd32x3::from(0.0).with_w(other[e5]) + other.group0().xyz().with_w(0.0),
        )
    }
}
...
impl std::ops::Sub<AntiDipoleInversion> for AntiFlector {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        AntiDipoleInversion::from_groups(
            ...
            // e235, e315, e125, e4
            (self.group0().xyz() - other.group2().xyz()).with_w(other[e4] * -1.0),
            // e1, e2, e3, e5
...
impl std::ops::Sub<MultiVector> for AntiFlector {
    ...
    fn sub(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (self.group1().xyz() - other.group1().xyz()).with_w(other[e4] * -1.0),
            // e5
            self[e5] - other[e5],
            // e15, e25, e35, e45
            other.group3() * Simd32x4::from(-1.0),
...
impl std::ops::Sub<VersorEven> for AntiFlector {
    ...
    fn sub(self, other: VersorEven) -> Self::Output {
        ...
        VersorEven::from_groups(
            ...
            // e1, e2, e3, e4
            (self.group1().xyz() - other.group3().xyz()).with_w(other[e4] * -1.0),
        )
    }
}
