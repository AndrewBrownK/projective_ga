...
impl std::ops::Sub<AntiCircleRotor> for AntiMotor {
    ...
    fn sub(self, other: AntiCircleRotor) -> Self::Output {
        ...
        VersorOdd::from_groups(
            ...
            // e23, e31, e12, e45
            (self.group0().xy() - other.group1().xy()).with_zw(self[e12] - other[e12], other[e45] * -1.0),
            // e15, e25, e35, e1234
...
impl std::ops::Sub<DipoleInversion> for AntiMotor {
    ...
    fn sub(self, other: DipoleInversion) -> Self::Output {
        ...
        VersorOdd::from_groups(
            ...
            (self.group0().xy() - other.group1().xy()).with_zw(self[e12] - other[e12], other[e45] * -1.0),
            // e15, e25, e35, e1234
            (self.group1().xy() - other.group2().xy()).with_zw(self[e35] - other[e35], other[e1234] * -1.0),
            // e4235, e4315, e4125, e3215
...
impl std::ops::Sub<MultiVector> for AntiMotor {
    ...
    fn sub(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            other[e5] * -1.0,
            // e15, e25, e35, e45
            (self.group1().xy() - other.group3().xy()).with_zw(self[e35] - other[e35], other[e45] * -1.0),
            // e41, e42, e43
...
impl TryFrom<Flector> for AntiMotor {
    ...
    fn try_from(flector: Flector) -> Result<Self, Self::Error> {
        ...
        Ok(AntiMotor::from_groups(
            ...
            Simd32x4::from(0.0),
            // e15, e25, e35, e3215
            flector.group0().xyz().with_w(flector[e3215]),
        ))
    }
}
...
impl TryFrom<VersorOdd> for AntiMotor {
    ...
    fn try_from(versor_odd: VersorOdd) -> Result<Self, Self::Error> {
        ...
        Ok(AntiMotor::from_groups(
            // e23, e31, e12, scalar
            versor_odd.group1().xyz().with_w(versor_odd[scalar]),
            // e15, e25, e35, e3215
            versor_odd.group2().xyz().with_w(versor_odd[e3215]),
        ))
    }
}
