...
impl std::ops::Add<AntiDipoleInversion> for Circle {
    ...
    fn add(self, other: AntiDipoleInversion) -> Self::Output {
        AntiDipoleInversion::from_groups(
            ...
            // e235, e315, e125, e4
            other.group2() + self.group2().with_w(0.0),
            // e1, e2, e3, e5
            other.group3(),
        )
    }
...
impl std::ops::Sub<AntiDipoleInversion> for Circle {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        AntiDipoleInversion::from_groups(
            ...
            self.group1() - other.group1(),
            // e235, e315, e125, e4
            (Simd32x3::from([other[e235] * -1.0, other[e315] * -1.0, other[e125] * -1.0]) + self.group2()).with_w(other[e4] * -1.0),
            // e1, e2, e3, e5
...
impl std::ops::Sub<AntiFlatPoint> for Circle {
    ...
    fn sub(self, other: AntiFlatPoint) -> Self::Output {
        ...
        Circle::from_groups(
            ...
            // e235, e315, e125
            Simd32x3::from([other[e235] * -1.0, other[e315] * -1.0, other[e125] * -1.0]) + self.group2(),
        )
    }
}
...
impl std::ops::Sub<CircleRotor> for Circle {
    ...
    fn sub(self, other: CircleRotor) -> Self::Output {
        ...
        CircleRotor::from_groups(
            ...
            self.group1() - other.group1(),
            // e235, e315, e125, e12345
            (Simd32x3::from([other[e235] * -1.0, other[e315] * -1.0, other[e125] * -1.0]) + self.group2()).with_w(other[e12345] * -1.0),
        )
    }
}
...
impl std::ops::Sub<Motor> for Circle {
    ...
    fn sub(self, other: Motor) -> Self::Output {
        ...
        VersorEven::from_groups(
            ...
            self.group1() + -other.group0().xyz().with_w(0.0),
            // e235, e315, e125, e5
            (Simd32x3::from([other[e235] * -1.0, other[e315] * -1.0, other[e125] * -1.0]) + self.group2()).with_w(other[e5] * -1.0),
            // e1, e2, e3, e4
            Simd32x4::from(0.0),
        )
    }
