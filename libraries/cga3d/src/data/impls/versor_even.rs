...
impl std::ops::Sub<AntiDipoleInversion> for VersorEven {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        VersorEven::from_groups(
            ...
            // e235, e315, e125, e5
            self.group2() + Simd32x3::from(0.0).with_w(other[e5] * -1.0) - other.group2().xyz().with_w(0.0),
            // e1, e2, e3, e4
            self.group3() + Simd32x3::from(0.0).with_w(other[e4] * -1.0) - other.group3().xyz().with_w(0.0),
        )
    }
}
...
impl std::ops::Sub<AntiFlector> for VersorEven {
    ...
    fn sub(self, other: AntiFlector) -> Self::Output {
        ...
        VersorEven::from_groups(
            ...
            self.group1().xyz().with_w(self[e321] - other[e321]),
            // e235, e315, e125, e5
            self.group2() + Simd32x3::from(0.0).with_w(other[e5] * -1.0) - other.group0().xyz().with_w(0.0),
            // e1, e2, e3, e4
            self.group3() - other.group1().xyz().with_w(0.0),
        )
    }
...
impl std::ops::Sub<CircleRotor> for VersorEven {
    ...
    fn sub(self, other: CircleRotor) -> Self::Output {
        ...
        VersorEven::from_groups(
            // e423, e431, e412, e12345
            self.group0() + Simd32x3::from(0.0).with_w(other[e12345] * -1.0) - other.group0().with_w(0.0),
            // e415, e425, e435, e321
            self.group1() - other.group1(),
            // e235, e315, e125, e5
            self.group2() - other.group2().xyz().with_w(0.0),
