...
impl std::ops::Add<MultiVector> for Line {
    ...
    fn add(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            other.group5(),
            // e415, e425, e435, e321
            other.group6() + self.group0().with_w(0.0),
            // e423, e431, e412
            other.group7(),
            // e235, e315, e125
...
impl std::ops::Sub<AntiDipoleInversion> for Line {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        AntiDipoleInversion::from_groups(
            ...
            other.group0() * Simd32x3::from(-1.0),
            // e415, e425, e435, e321
            (self.group0() - other.group1().xyz()).with_w(other[e321] * -1.0),
            // e235, e315, e125, e4
            (self.group1() - other.group2().xyz()).with_w(other[e4] * -1.0),
            // e1, e2, e3, e5
...
impl std::ops::Sub<CircleRotor> for Line {
    ...
    fn sub(self, other: CircleRotor) -> Self::Output {
        ...
        CircleRotor::from_groups(
            ...
            (self.group0() - other.group1().xyz()).with_w(other[e321] * -1.0),
            // e235, e315, e125, e12345
            (self.group1() - other.group2().xyz()).with_w(other[e12345] * -1.0),
        )
    }
}
...
impl std::ops::Sub<Motor> for Line {
    ...
    fn sub(self, other: Motor) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e235, e315, e125, e5
            (self.group1() - other.group1().xyz()).with_w(other[e5] * -1.0),
        )
    }
}
impl std::ops::Sub<MultiVector> for Line {
    ...
    fn sub(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e415, e425, e435, e321
            (self.group0() - other.group6().xyz()).with_w(other[e321] * -1.0),
            // e423, e431, e412
