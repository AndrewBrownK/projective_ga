...
impl std::ops::Sub<AntiCircleRotor> for Sphere {
    ...
    fn sub(self, other: AntiCircleRotor) -> Self::Output {
        ...
        VersorOdd::from_groups(
            ...
            // e15, e25, e35, e1234
            (other.group2().xyz() * Simd32x3::from(-1.0)).with_w(self[e1234]),
            // e4235, e4315, e4125, e3215
            self.group0(),
        )
    }
...
impl std::ops::Sub<AntiLine> for Sphere {
    ...
    fn sub(self, other: AntiLine) -> Self::Output {
        ...
        DipoleInversion::from_groups(
            ...
            // e15, e25, e35, e1234
            (other.group1() * Simd32x3::from(-1.0)).with_w(self[e1234]),
            // e4235, e4315, e4125, e3215
            self.group0(),
        )
    }
...
impl std::ops::Sub<AntiMotor> for Sphere {
    ...
    fn sub(self, other: AntiMotor) -> Self::Output {
        ...
        VersorOdd::from_groups(
            ...
            // e15, e25, e35, e1234
            (other.group1().xyz() * Simd32x3::from(-1.0)).with_w(self[e1234]),
            // e4235, e4315, e4125, e3215
            self.group0().xyz().with_w(self[e3215] - other[e3215]),
        )
    }
...
impl std::ops::Sub<Dipole> for Sphere {
    ...
    fn sub(self, other: Dipole) -> Self::Output {
        ...
        DipoleInversion::from_groups(
            ...
            other.group1() * Simd32x4::from(-1.0),
            // e15, e25, e35, e1234
            (other.group2() * Simd32x3::from(-1.0)).with_w(self[e1234]),
            // e4235, e4315, e4125, e3215
            self.group0(),
        )
    }
...
impl std::ops::Sub<DipoleInversion> for Sphere {
    ...
    fn sub(self, other: DipoleInversion) -> Self::Output {
        ...
        DipoleInversion::from_groups(
            ...
            other.group1() * Simd32x4::from(-1.0),
            // e15, e25, e35, e1234
            (other.group2().xyz() * Simd32x3::from(-1.0)).with_w(self[e1234] - other[e1234]),
            // e4235, e4315, e4125, e3215
            self.group0() - other.group3(),
        )
    }
...
impl std::ops::Sub<FlatPoint> for Sphere {
    ...
    fn sub(self, other: FlatPoint) -> Self::Output {
        ...
        DipoleInversion::from_groups(
            ...
            // e15, e25, e35, e1234
            (other.group0().xyz() * Simd32x3::from(-1.0)).with_w(self[e1234]),
            // e4235, e4315, e4125, e3215
            self.group0(),
        )
    }
...
impl TryFrom<MultiVector> for Sphere {
    ...
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        Ok(Sphere::from_groups(/* e4235, e4315, e4125, e3215 */ multi_vector.group9(), /* e1234 */ multi_vector[e1234]))
    }
}
