...
impl std::ops::Add<AntiFlatOrigin> for AntiFlatPoint {
    ...
    fn add(self, other: AntiFlatOrigin) -> Self::Output {
        use crate::elements::*;
        AntiFlatPoint::from_groups(/* e235, e315, e125, e321 */ self.group0() + Simd32x3::from(0.0).with_w(other[e321]))
    }
}
...
impl std::ops::Add<AntiPlaneOnOrigin> for AntiFlatPoint {
    ...
    fn add(self, other: AntiPlaneOnOrigin) -> Self::Output {
        AntiFlector::from_groups(/* e235, e315, e125, e321 */ self.group0(), /* e1, e2, e3, e5 */ other.group0().with_w(0.0))
    }
}
...
impl std::ops::Add<Infinity> for AntiFlatPoint {
    ...
    fn add(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        AntiFlector::from_groups(/* e235, e315, e125, e321 */ self.group0(), /* e1, e2, e3, e5 */ Simd32x3::from(0.0).with_w(other[e5]))
    }
}
...
impl std::ops::Add<LineAtInfinity> for AntiFlatPoint {
    ...
    fn add(self, other: LineAtInfinity) -> Self::Output {
        use crate::elements::*;
        AntiFlatPoint::from_groups(/* e235, e315, e125, e321 */ (other.group0() + self.group0().xyz()).with_w(self[e321]))
    }
}
...
impl std::ops::Add<LineOnOrigin> for AntiFlatPoint {
    ...
    fn add(self, other: LineOnOrigin) -> Self::Output {
        use crate::elements::*;
        CircleAtInfinity::from_groups(/* e415, e425, e435, e321 */ other.group0().with_w(self[e321]), /* e235, e315, e125 */ self.group0().xyz())
    }
}
...
impl std::ops::Add<NullCircleAtOrigin> for AntiFlatPoint {
    ...
    fn add(self, other: NullCircleAtOrigin) -> Self::Output {
        use crate::elements::*;
        CircleOrthogonalOrigin::from_groups(/* e423, e431, e412, e321 */ other.group0().with_w(self[e321]), /* e235, e315, e125 */ self.group0().xyz())
    }
}
...
impl std::ops::Sub<AntiFlatOrigin> for AntiFlatPoint {
    ...
    fn sub(self, other: AntiFlatOrigin) -> Self::Output {
        use crate::elements::*;
        AntiFlatPoint::from_groups(/* e235, e315, e125, e321 */ self.group0() + Simd32x3::from(0.0).with_w(other[e321] * -1.0))
    }
}
