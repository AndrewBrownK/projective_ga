...
impl TryFrom<AntiDipoleInversionOnOrigin> for AntiPlane {
    ...
    fn try_from(anti_dipole_inversion_on_origin: AntiDipoleInversionOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(AntiPlane::from_groups(/* e1, e2, e3, e5 */ anti_dipole_inversion_on_origin.group1().yzw().with_w(0.0)))
    }
}
...
impl TryFrom<AntiFlectorOnOrigin> for AntiPlane {
    ...
    fn try_from(anti_flector_on_origin: AntiFlectorOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(AntiPlane::from_groups(/* e1, e2, e3, e5 */ anti_flector_on_origin.group0().yzw().with_w(0.0)))
    }
}
...
impl TryFrom<MysteryVersorEven> for AntiPlane {
    ...
    fn try_from(mystery_versor_even: MysteryVersorEven) -> Result<Self, Self::Error> {
        ...
        Ok(AntiPlane::from_groups(/* e1, e2, e3, e5 */ mystery_versor_even.group0().yzw().with_w(0.0)))
    }
}
