...
impl std::ops::Add<AntiCircleOnOrigin> for AntiCircleOnOrigin {
    ...
    fn add(self, other: AntiCircleOnOrigin) -> Self::Output {
        AntiCircleOnOrigin::from_groups(/* e41, e42, e43 */ other.group0() + self.group0(), /* e23, e31, e12 */ other.group1() + self.group1())
    }
}
...
impl std::ops::Add<AntiLineOnOrigin> for AntiCircleOnOrigin {
    ...
    fn add(self, other: AntiLineOnOrigin) -> Self::Output {
        AntiCircleOnOrigin::from_groups(/* e41, e42, e43 */ self.group0(), /* e23, e31, e12 */ self.group1() + other.group0())
    }
}
...
impl std::ops::Add<FlatPointAtInfinity> for AntiCircleOnOrigin {
    ...
    fn add(self, other: FlatPointAtInfinity) -> Self::Output {
        DipoleOrthogonalOrigin::from_groups(/* e41, e42, e43 */ self.group0(), /* e23, e31, e12 */ self.group1(), /* e15, e25, e35 */ other.group0())
    }
}
...
impl std::ops::Add<NullDipoleAtOrigin> for AntiCircleOnOrigin {
    ...
    fn add(self, other: NullDipoleAtOrigin) -> Self::Output {
        AntiCircleOnOrigin::from_groups(/* e41, e42, e43 */ self.group0() + other.group0(), /* e23, e31, e12 */ self.group1())
    }
}
...
impl std::ops::Add<Scalar> for AntiCircleOnOrigin {
    ...
    fn add(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        AntiCircleRotorOnOrigin::from_groups(/* e41, e42, e43, scalar */ self.group0().with_w(other[scalar]), /* e23, e31, e12 */ self.group1())
    }
}
...
impl From<AntiLineOnOrigin> for AntiCircleOnOrigin {
    fn from(from_anti_line_on_origin: AntiLineOnOrigin) -> Self {
        AntiCircleOnOrigin::from_groups(/* e41, e42, e43 */ Simd32x3::from(0.0), /* e23, e31, e12 */ from_anti_line_on_origin.group0())
    }
}

impl From<NullDipoleAtOrigin> for AntiCircleOnOrigin {
    fn from(from_null_dipole_at_origin: NullDipoleAtOrigin) -> Self {
        AntiCircleOnOrigin::from_groups(/* e41, e42, e43 */ from_null_dipole_at_origin.group0(), /* e23, e31, e12 */ Simd32x3::from(0.0))
    }
}
...
impl std::ops::Sub<AntiCircleOnOrigin> for AntiCircleOnOrigin {
    ...
    fn sub(self, other: AntiCircleOnOrigin) -> Self::Output {
        AntiCircleOnOrigin::from_groups(/* e41, e42, e43 */ self.group0() - other.group0(), /* e23, e31, e12 */ self.group1() - other.group1())
    }
}
...
impl std::ops::Sub<Scalar> for AntiCircleOnOrigin {
    ...
    fn sub(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        AntiCircleRotorOnOrigin::from_groups(/* e41, e42, e43, scalar */ self.group0().with_w(other[scalar] * -1.0), /* e23, e31, e12 */ self.group1())
    }
}
...
impl TryFrom<AntiCircleRotor> for AntiCircleOnOrigin {
    ...
    fn try_from(anti_circle_rotor: AntiCircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(AntiCircleOnOrigin::from_groups(
            // e41, e42, e43
