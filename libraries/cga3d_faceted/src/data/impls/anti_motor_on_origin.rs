...
impl TryFrom<AntiCircleRotor> for AntiMotorOnOrigin {
    ...
    fn try_from(anti_circle_rotor: AntiCircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(AntiMotorOnOrigin::from_groups(
            // e23, e31, e12, scalar
            anti_circle_rotor.group1().xyz().with_w(anti_circle_rotor[scalar]),
        ))
    }
}
...
impl TryFrom<AntiCircleRotorAtInfinity> for AntiMotorOnOrigin {
    ...
    fn try_from(anti_circle_rotor_at_infinity: AntiCircleRotorAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(AntiMotorOnOrigin::from_groups(
            // e23, e31, e12, scalar
            anti_circle_rotor_at_infinity.group0().xyz().with_w(anti_circle_rotor_at_infinity[scalar]),
        ))
    }
}
...
impl TryFrom<AntiMysteryCircleRotor> for AntiMotorOnOrigin {
    ...
    fn try_from(anti_mystery_circle_rotor: AntiMysteryCircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(AntiMotorOnOrigin::from_groups(
            // e23, e31, e12, scalar
            anti_mystery_circle_rotor.group0().xyz().with_w(anti_mystery_circle_rotor[scalar]),
        ))
    }
}
...
impl TryFrom<MysteryVersorOdd> for AntiMotorOnOrigin {
    ...
    fn try_from(mystery_versor_odd: MysteryVersorOdd) -> Result<Self, Self::Error> {
        ...
        Ok(AntiMotorOnOrigin::from_groups(
            // e23, e31, e12, scalar
            mystery_versor_odd.group1().xyz().with_w(mystery_versor_odd[scalar]),
        ))
    }
}
...
impl TryFrom<VersorOddAtInfinity> for AntiMotorOnOrigin {
    ...
    fn try_from(versor_odd_at_infinity: VersorOddAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(AntiMotorOnOrigin::from_groups(
            // e23, e31, e12, scalar
            versor_odd_at_infinity.group1().xyz().with_w(versor_odd_at_infinity[scalar]),
        ))
    }
}
