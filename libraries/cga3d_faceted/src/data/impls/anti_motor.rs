...
impl std::ops::Add<AntiMotorOnOrigin> for AntiMotor {
    ...
    fn add(self, other: AntiMotorOnOrigin) -> Self::Output {
        AntiMotor::from_groups(/* e23, e31, e12, scalar */ self.group0() + other.group0(), /* e15, e25, e35, e3215 */ self.group1())
    }
}
...
impl std::ops::Add<FlectorAtInfinity> for AntiMotor {
    ...
    fn add(self, other: FlectorAtInfinity) -> Self::Output {
        AntiMotor::from_groups(/* e23, e31, e12, scalar */ self.group0(), /* e15, e25, e35, e3215 */ self.group1() + other.group0())
    }
}
...
impl From<AntiMotorOnOrigin> for AntiMotor {
    fn from(from_anti_motor_on_origin: AntiMotorOnOrigin) -> Self {
        AntiMotor::from_groups(/* e23, e31, e12, scalar */ from_anti_motor_on_origin.group0(), /* e15, e25, e35, e3215 */ Simd32x4::from(0.0))
    }
}
...
impl From<FlectorAtInfinity> for AntiMotor {
    fn from(from_flector_at_infinity: FlectorAtInfinity) -> Self {
        AntiMotor::from_groups(/* e23, e31, e12, scalar */ Simd32x4::from(0.0), /* e15, e25, e35, e3215 */ from_flector_at_infinity.group0())
    }
}
