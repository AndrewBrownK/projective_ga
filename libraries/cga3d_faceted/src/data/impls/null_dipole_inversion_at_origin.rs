...
impl From<NullDipoleAtOrigin> for NullDipoleInversionAtOrigin {
    fn from(from_null_dipole_at_origin: NullDipoleAtOrigin) -> Self {
        NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ from_null_dipole_at_origin.group0().with_w(0.0))
    }
}
...
impl From<NullSphereAtOrigin> for NullDipoleInversionAtOrigin {
    fn from(from_null_sphere_at_origin: NullSphereAtOrigin) -> Self {
        use crate::elements::*;
        NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x3::from(0.0).with_w(from_null_sphere_at_origin[e1234]))
    }
}
...
impl TryFrom<AntiCircleOnOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(anti_circle_on_origin: AntiCircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ anti_circle_on_origin.group0().with_w(0.0)))
    }
}
...
impl TryFrom<AntiCircleRotor> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(anti_circle_rotor: AntiCircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ anti_circle_rotor.group0().with_w(0.0)))
    }
}
...
impl TryFrom<AntiCircleRotorAligningOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(anti_circle_rotor_aligning_origin: AntiCircleRotorAligningOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
...
impl TryFrom<AntiVersorEvenOnOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(anti_versor_even_on_origin: AntiVersorEvenOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
            anti_versor_even_on_origin.group0().xyz().with_w(anti_versor_even_on_origin[e1234]),
        ))
    }
}
...
impl TryFrom<Dipole> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole: Dipole) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ dipole.group0().with_w(0.0)))
    }
}
...
impl TryFrom<DipoleAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_at_origin: DipoleAtOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ dipole_at_origin.group0().with_w(0.0)))
    }
}
...
impl TryFrom<DipoleInversionAligningOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_inversion_aligning_origin: DipoleInversionAligningOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
            dipole_inversion_aligning_origin.group0().xyz().with_w(dipole_inversion_aligning_origin[e1234]),
        ))
    }
}
...
impl TryFrom<DipoleInversionAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_inversion_at_origin: DipoleInversionAtOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
            dipole_inversion_at_origin.group0().xyz().with_w(dipole_inversion_at_origin[e1234]),
        ))
    }
}
...
impl TryFrom<DipoleInversionOnOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_inversion_on_origin: DipoleInversionOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
            dipole_inversion_on_origin.group0().xyz().with_w(dipole_inversion_on_origin[e1234]),
        ))
    }
}
...
impl TryFrom<DipoleInversionOrthogonalOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_inversion_orthogonal_origin: DipoleInversionOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
            dipole_inversion_orthogonal_origin.group0().xyz().with_w(dipole_inversion_orthogonal_origin[e1234]),
        ))
    }
}
...
impl TryFrom<DipoleOnOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_on_origin: DipoleOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ dipole_on_origin.group0().xyz().with_w(0.0)))
    }
}
...
impl TryFrom<DipoleOrthogonalOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_orthogonal_origin: DipoleOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ dipole_orthogonal_origin.group0().with_w(0.0)))
    }
}
...
impl TryFrom<Sphere> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(sphere: Sphere) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x3::from(0.0).with_w(sphere[e1234])))
    }
}
...
impl TryFrom<VersorOdd> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(versor_odd: VersorOdd) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
            versor_odd.group0().xyz().with_w(versor_odd[e1234]),
        ))
    }
}
...
impl TryFrom<VersorOddOrthogonalOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(versor_odd_orthogonal_origin: VersorOddOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
            versor_odd_orthogonal_origin.group0().xyz().with_w(versor_odd_orthogonal_origin[e1234]),
        ))
    }
}
