...
impl std::ops::Add<AntiFlatOrigin> for LineOnOrigin {
    ...
    fn add(self, other: AntiFlatOrigin) -> Self::Output {
        use crate::elements::*;
        MysteryCircle::from_groups(/* e415, e425, e435, e321 */ self.group0().with_w(other[e321]))
    }
}
impl std::ops::Add<AntiFlatPoint> for LineOnOrigin {
    ...
    fn add(self, other: AntiFlatPoint) -> Self::Output {
        use crate::elements::*;
        CircleAtInfinity::from_groups(/* e415, e425, e435, e321 */ self.group0().with_w(other[e321]), /* e235, e315, e125 */ other.group0().xyz())
    }
}
...
impl std::ops::Add<AntiFlectorOnOrigin> for LineOnOrigin {
    ...
    fn add(self, other: AntiFlectorOnOrigin) -> Self::Output {
        use crate::elements::*;
        AntiMysteryDipoleInversion::from_groups(/* e415, e425, e435, e321 */ self.group0().with_w(other[e321]), /* e1, e2, e3 */ other.group0().yzw())
    }
}
...
impl std::ops::Add<AntiPlaneOnOrigin> for LineOnOrigin {
    ...
    fn add(self, other: AntiPlaneOnOrigin) -> Self::Output {
        AntiMysteryDipoleInversion::from_groups(/* e415, e425, e435, e321 */ self.group0().with_w(0.0), /* e1, e2, e3 */ other.group0())
    }
}
impl std::ops::Add<AntiScalar> for LineOnOrigin {
    ...
    fn add(self, other: AntiScalar) -> Self::Output {
        use crate::elements::*;
        MotorOnOrigin::from_groups(/* e415, e425, e435, e12345 */ self.group0().with_w(other[e12345]))
    }
}
...
impl std::ops::Add<CircleOnOrigin> for LineOnOrigin {
    ...
    fn add(self, other: CircleOnOrigin) -> Self::Output {
        CircleOnOrigin::from_groups(/* e423, e431, e412 */ other.group0(), /* e415, e425, e435 */ other.group1() + self.group0())
    }
}
...
impl std::ops::Add<CircleRotorOnOrigin> for LineOnOrigin {
    ...
    fn add(self, other: CircleRotorOnOrigin) -> Self::Output {
        CircleRotorOnOrigin::from_groups(/* e423, e431, e412, e12345 */ other.group0(), /* e415, e425, e435 */ other.group1() + self.group0())
    }
}
...
impl std::ops::Add<Line> for LineOnOrigin {
    ...
    fn add(self, other: Line) -> Self::Output {
        Line::from_groups(/* e415, e425, e435 */ other.group0() + self.group0(), /* e235, e315, e125 */ other.group1())
    }
}
impl std::ops::Add<LineAtInfinity> for LineOnOrigin {
    type Output = Line;
    fn add(self, other: LineAtInfinity) -> Self::Output {
        Line::from_groups(/* e415, e425, e435 */ self.group0(), /* e235, e315, e125 */ other.group0())
    }
}
impl std::ops::Add<LineOnOrigin> for LineOnOrigin {
    ...
    fn add(self, other: LineOnOrigin) -> Self::Output {
        LineOnOrigin::from_groups(/* e415, e425, e435 */ other.group0() + self.group0())
    }
}
...
impl std::ops::Add<MotorAtInfinity> for LineOnOrigin {
    ...
    fn add(self, other: MotorAtInfinity) -> Self::Output {
        Motor::from_groups(/* e415, e425, e435, e12345 */ self.group0().with_w(0.0), /* e235, e315, e125, e5 */ other.group0())
    }
}
impl std::ops::Add<MotorOnOrigin> for LineOnOrigin {
    ...
    fn add(self, other: MotorOnOrigin) -> Self::Output {
        use crate::elements::*;
        MotorOnOrigin::from_groups(/* e415, e425, e435, e12345 */ (self.group0() + other.group0().xyz()).with_w(other[e12345]))
    }
}
...
impl std::ops::Add<MysteryCircle> for LineOnOrigin {
    ...
    fn add(self, other: MysteryCircle) -> Self::Output {
        use crate::elements::*;
        MysteryCircle::from_groups(/* e415, e425, e435, e321 */ (self.group0() + other.group0().xyz()).with_w(other[e321]))
    }
}
...
impl std::ops::Add<NullCircleAtOrigin> for LineOnOrigin {
    ...
    fn add(self, other: NullCircleAtOrigin) -> Self::Output {
        CircleOnOrigin::from_groups(/* e423, e431, e412 */ other.group0(), /* e415, e425, e435 */ self.group0())
    }
}
...
impl std::ops::Add<Origin> for LineOnOrigin {
    ...
    fn add(self, other: Origin) -> Self::Output {
        use crate::elements::*;
        VersorEvenOnOrigin::from_groups(/* e423, e431, e412, e12345 */ Simd32x4::from(0.0), /* e415, e425, e435, e4 */ self.group0().with_w(other[e4]))
    }
}
...
impl std::ops::Sub<AntiFlatOrigin> for LineOnOrigin {
    ...
    fn sub(self, other: AntiFlatOrigin) -> Self::Output {
        use crate::elements::*;
        MysteryCircle::from_groups(/* e415, e425, e435, e321 */ self.group0().with_w(other[e321] * -1.0))
    }
}
...
impl std::ops::Sub<AntiPlaneOnOrigin> for LineOnOrigin {
    ...
    fn sub(self, other: AntiPlaneOnOrigin) -> Self::Output {
        AntiMysteryDipoleInversion::from_groups(/* e415, e425, e435, e321 */ self.group0().with_w(0.0), /* e1, e2, e3 */ other.group0() * Simd32x3::from(-1.0))
    }
}
impl std::ops::Sub<AntiScalar> for LineOnOrigin {
    ...
    fn sub(self, other: AntiScalar) -> Self::Output {
        use crate::elements::*;
        MotorOnOrigin::from_groups(/* e415, e425, e435, e12345 */ self.group0().with_w(other[e12345] * -1.0))
    }
}
...
impl std::ops::Sub<LineAtInfinity> for LineOnOrigin {
    ...
    fn sub(self, other: LineAtInfinity) -> Self::Output {
        Line::from_groups(/* e415, e425, e435 */ self.group0(), /* e235, e315, e125 */ other.group0() * Simd32x3::from(-1.0))
    }
}
impl std::ops::Sub<LineOnOrigin> for LineOnOrigin {
    ...
    fn sub(self, other: LineOnOrigin) -> Self::Output {
        LineOnOrigin::from_groups(/* e415, e425, e435 */ self.group0() - other.group0())
    }
}
...
impl std::ops::Sub<NullCircleAtOrigin> for LineOnOrigin {
    ...
    fn sub(self, other: NullCircleAtOrigin) -> Self::Output {
        CircleOnOrigin::from_groups(/* e423, e431, e412 */ other.group0() * Simd32x3::from(-1.0), /* e415, e425, e435 */ self.group0())
    }
}
...
impl TryFrom<AntiDipoleInversion> for LineOnOrigin {
    ...
    fn try_from(anti_dipole_inversion: AntiDipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ anti_dipole_inversion.group1().xyz()))
    }
}
...
impl TryFrom<AntiDipoleInversionAtInfinity> for LineOnOrigin {
    ...
    fn try_from(anti_dipole_inversion_at_infinity: AntiDipoleInversionAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ anti_dipole_inversion_at_infinity.group0().xyz()))
    }
}
...
impl TryFrom<AntiDipoleInversionOrthogonalOrigin> for LineOnOrigin {
    ...
    fn try_from(anti_dipole_inversion_orthogonal_origin: AntiDipoleInversionOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ anti_dipole_inversion_orthogonal_origin.group1()))
    }
}
...
impl TryFrom<AntiMysteryDipoleInversion> for LineOnOrigin {
    ...
    fn try_from(anti_mystery_dipole_inversion: AntiMysteryDipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ anti_mystery_dipole_inversion.group0().xyz()))
    }
}
...
impl TryFrom<Circle> for LineOnOrigin {
    ...
    fn try_from(circle: Circle) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle.group1().xyz()))
    }
}
...
impl TryFrom<CircleAligningOrigin> for LineOnOrigin {
    ...
    fn try_from(circle_aligning_origin: CircleAligningOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle_aligning_origin.group1()))
    }
}
...
impl TryFrom<CircleAtInfinity> for LineOnOrigin {
    ...
    fn try_from(circle_at_infinity: CircleAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle_at_infinity.group0().xyz()))
    }
}
...
impl TryFrom<CircleOnOrigin> for LineOnOrigin {
    ...
    fn try_from(circle_on_origin: CircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle_on_origin.group1()))
    }
}
...
impl TryFrom<CircleRotor> for LineOnOrigin {
    ...
    fn try_from(circle_rotor: CircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle_rotor.group1().xyz()))
    }
}
...
impl TryFrom<CircleRotorAligningOrigin> for LineOnOrigin {
    ...
    fn try_from(circle_rotor_aligning_origin: CircleRotorAligningOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle_rotor_aligning_origin.group1()))
    }
}
...
impl TryFrom<CircleRotorAligningOriginAtInfinity> for LineOnOrigin {
    ...
    fn try_from(circle_rotor_aligning_origin_at_infinity: CircleRotorAligningOriginAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle_rotor_aligning_origin_at_infinity.group0()))
    }
}
...
impl TryFrom<CircleRotorAtInfinity> for LineOnOrigin {
    ...
    fn try_from(circle_rotor_at_infinity: CircleRotorAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle_rotor_at_infinity.group0().xyz()))
    }
}
...
impl TryFrom<CircleRotorOnOrigin> for LineOnOrigin {
    ...
    fn try_from(circle_rotor_on_origin: CircleRotorOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ circle_rotor_on_origin.group1()))
    }
}
...
impl TryFrom<Line> for LineOnOrigin {
    ...
    fn try_from(line: Line) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ line.group0()))
    }
}
...
impl TryFrom<Motor> for LineOnOrigin {
    ...
    fn try_from(motor: Motor) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ motor.group0().xyz()))
    }
}
...
impl TryFrom<MotorOnOrigin> for LineOnOrigin {
    ...
    fn try_from(motor_on_origin: MotorOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ motor_on_origin.group0().xyz()))
    }
}
...
impl TryFrom<MultiVector> for LineOnOrigin {
    ...
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ multi_vector.group6().xyz()))
    }
}
...
impl TryFrom<MysteryCircle> for LineOnOrigin {
    ...
    fn try_from(mystery_circle: MysteryCircle) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ mystery_circle.group0().xyz()))
    }
}
...
impl TryFrom<MysteryCircleRotor> for LineOnOrigin {
    ...
    fn try_from(mystery_circle_rotor: MysteryCircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ mystery_circle_rotor.group0().xyz()))
    }
}
...
impl TryFrom<MysteryVersorEven> for LineOnOrigin {
    ...
    fn try_from(mystery_versor_even: MysteryVersorEven) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ mystery_versor_even.group1().xyz()))
    }
}
...
impl TryFrom<VersorEven> for LineOnOrigin {
    ...
    fn try_from(versor_even: VersorEven) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ versor_even.group1().xyz()))
    }
}
...
impl TryFrom<VersorEvenAligningOrigin> for LineOnOrigin {
    ...
    fn try_from(versor_even_aligning_origin: VersorEvenAligningOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ versor_even_aligning_origin.group1().xyz()))
    }
}
...
impl TryFrom<VersorEvenAtInfinity> for LineOnOrigin {
    ...
    fn try_from(versor_even_at_infinity: VersorEvenAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ versor_even_at_infinity.group1().xyz()))
    }
}
...
impl TryFrom<VersorEvenOnOrigin> for LineOnOrigin {
    ...
    fn try_from(versor_even_on_origin: VersorEvenOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(LineOnOrigin::from_groups(/* e415, e425, e435 */ versor_even_on_origin.group1().xyz()))
    }
}
