...
impl std::ops::Add<AntiPlane> for RoundPointAtOrigin {
    ...
    fn add(self, other: AntiPlane) -> Self::Output {
        use crate::elements::*;
        RoundPoint::from_groups(/* e1, e2, e3, e4 */ other.group0().xyz().with_w(self[e4]), /* e5 */ other[e5] + self[e5])
    }
}
impl std::ops::Add<AntiPlaneOnOrigin> for RoundPointAtOrigin {
    ...
    fn add(self, other: AntiPlaneOnOrigin) -> Self::Output {
        use crate::elements::*;
        RoundPoint::from_groups(/* e1, e2, e3, e4 */ other.group0().with_w(self[e4]), /* e5 */ self[e5])
    }
}
...
impl std::ops::Add<AntiSphereOnOrigin> for RoundPointAtOrigin {
    ...
    fn add(self, other: AntiSphereOnOrigin) -> Self::Output {
        use crate::elements::*;
        RoundPoint::from_groups(/* e1, e2, e3, e4 */ other.group0().xyz().with_w(other[e4] + self[e4]), /* e5 */ self[e5])
    }
}
...
impl std::ops::Add<Infinity> for RoundPointAtOrigin {
    ...
    fn add(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, other[e5]]) + self.group0())
    }
}
...
impl std::ops::Add<Origin> for RoundPointAtOrigin {
    ...
    fn add(self, other: Origin) -> Self::Output {
        use crate::elements::*;
        RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([other[e4], 0.0]) + self.group0())
    }
}
...
impl std::ops::Add<RoundPoint> for RoundPointAtOrigin {
    ...
    fn add(self, other: RoundPoint) -> Self::Output {
        use crate::elements::*;
        RoundPoint::from_groups(/* e1, e2, e3, e4 */ other.group0().xyz().with_w(other[e4] + self[e4]), /* e5 */ other[e5] + self[e5])
    }
}
impl std::ops::Add<RoundPointAtOrigin> for RoundPointAtOrigin {
    ...
    fn add(self, other: RoundPointAtOrigin) -> Self::Output {
        RoundPointAtOrigin::from_groups(/* e4, e5 */ other.group0() + self.group0())
    }
}
...
impl From<Infinity> for RoundPointAtOrigin {
    fn from(from_infinity: Infinity) -> Self {
        use crate::elements::*;
        RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, from_infinity[e5]]))
    }
}
...
impl From<Origin> for RoundPointAtOrigin {
    fn from(from_origin: Origin) -> Self {
        use crate::elements::*;
        RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([from_origin[e4], 0.0]))
    }
}
...
impl std::ops::Sub<Infinity> for RoundPointAtOrigin {
    ...
    fn sub(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, other[e5] * -1.0]) + self.group0())
    }
}
...
impl std::ops::Sub<Origin> for RoundPointAtOrigin {
    ...
    fn sub(self, other: Origin) -> Self::Output {
        use crate::elements::*;
        RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([other[e4] * -1.0, 0.0]) + self.group0())
    }
}
...
impl std::ops::Sub<RoundPointAtOrigin> for RoundPointAtOrigin {
    ...
    fn sub(self, other: RoundPointAtOrigin) -> Self::Output {
        RoundPointAtOrigin::from_groups(/* e4, e5 */ self.group0() - other.group0())
    }
}
...
impl TryFrom<AntiDipoleInversion> for RoundPointAtOrigin {
    ...
    fn try_from(anti_dipole_inversion: AntiDipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(
            // e4, e5
...
impl TryFrom<AntiDipoleInversionAtInfinity> for RoundPointAtOrigin {
    ...
    fn try_from(anti_dipole_inversion_at_infinity: AntiDipoleInversionAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, anti_dipole_inversion_at_infinity[e5]])))
    }
}
...
impl TryFrom<AntiDipoleInversionOnOrigin> for RoundPointAtOrigin {
    ...
    fn try_from(anti_dipole_inversion_on_origin: AntiDipoleInversionOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([anti_dipole_inversion_on_origin[e4], 0.0])))
    }
}
...
impl TryFrom<AntiDipoleInversionOrthogonalOrigin> for RoundPointAtOrigin {
    ...
    fn try_from(anti_dipole_inversion_orthogonal_origin: AntiDipoleInversionOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([
...
impl TryFrom<AntiFlector> for RoundPointAtOrigin {
    ...
    fn try_from(anti_flector: AntiFlector) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, anti_flector[e5]])))
    }
}
...
impl TryFrom<AntiPlane> for RoundPointAtOrigin {
    ...
    fn try_from(anti_plane: AntiPlane) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, anti_plane[e5]])))
    }
}
...
impl TryFrom<AntiSphereOnOrigin> for RoundPointAtOrigin {
    ...
    fn try_from(anti_sphere_on_origin: AntiSphereOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([anti_sphere_on_origin[e4], 0.0])))
    }
}
...
impl TryFrom<DualNum> for RoundPointAtOrigin {
    ...
    fn try_from(dual_num: DualNum) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([dual_num[e4], 0.0])))
    }
}
...
impl TryFrom<Motor> for RoundPointAtOrigin {
    ...
    fn try_from(motor: Motor) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, motor[e5]])))
    }
}
...
impl TryFrom<MotorAtInfinity> for RoundPointAtOrigin {
    ...
    fn try_from(motor_at_infinity: MotorAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, motor_at_infinity[e5]])))
    }
}
...
impl TryFrom<MultiVector> for RoundPointAtOrigin {
    ...
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([multi_vector[e4], multi_vector[e5]])))
    }
}
...
impl TryFrom<NullVersorEvenAtOrigin> for RoundPointAtOrigin {
    ...
    fn try_from(null_versor_even_at_origin: NullVersorEvenAtOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([null_versor_even_at_origin[e4], 0.0])))
    }
}
...
impl TryFrom<RoundPoint> for RoundPointAtOrigin {
    ...
    fn try_from(round_point: RoundPoint) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([round_point[e4], round_point[e5]])))
    }
}
...
impl TryFrom<VersorEven> for RoundPointAtOrigin {
    ...
    fn try_from(versor_even: VersorEven) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([versor_even[e4], versor_even[e5]])))
    }
}
...
impl TryFrom<VersorEvenAtInfinity> for RoundPointAtOrigin {
    ...
    fn try_from(versor_even_at_infinity: VersorEvenAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([0.0, versor_even_at_infinity[e5]])))
    }
}
...
impl TryFrom<VersorEvenOnOrigin> for RoundPointAtOrigin {
    ...
    fn try_from(versor_even_on_origin: VersorEvenOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([versor_even_on_origin[e4], 0.0])))
    }
}
