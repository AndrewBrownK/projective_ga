...
impl TryFrom<AntiFlectorOnOrigin> for AntiSphereOnOrigin {
    ...
    fn try_from(anti_flector_on_origin: AntiFlectorOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(AntiSphereOnOrigin::from_groups(/* e1, e2, e3, e4 */ anti_flector_on_origin.group0().yzw().with_w(0.0)))
    }
}
...
impl TryFrom<MysteryVersorEven> for AntiSphereOnOrigin {
    ...
    fn try_from(mystery_versor_even: MysteryVersorEven) -> Result<Self, Self::Error> {
        ...
        Ok(AntiSphereOnOrigin::from_groups(/* e1, e2, e3, e4 */ mystery_versor_even.group0().yzw().with_w(0.0)))
    }
}
...
impl TryFrom<VersorEvenAtInfinity> for AntiSphereOnOrigin {
    ...
    fn try_from(versor_even_at_infinity: VersorEvenAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(AntiSphereOnOrigin::from_groups(/* e1, e2, e3, e4 */ versor_even_at_infinity.group0().yzw().with_w(0.0)))
    }
}
