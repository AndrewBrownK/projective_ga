...
impl TryFrom<CircleRotor> for MotorOnOrigin {
    ...
    fn try_from(circle_rotor: CircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(MotorOnOrigin::from_groups(/* e415, e425, e435, e12345 */ circle_rotor.group1().xyz().with_w(circle_rotor[e12345])))
    }
}
...
impl TryFrom<MultiVector> for MotorOnOrigin {
    ...
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        Ok(MotorOnOrigin::from_groups(/* e415, e425, e435, e12345 */ multi_vector.group6().xyz().with_w(multi_vector[e12345])))
    }
}
