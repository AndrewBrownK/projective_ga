...
impl std::ops::Add<FlatPoint> for Plane {
    ...
    fn add(self, other: FlatPoint) -> Self::Output {
        Flector::from_groups(/* e15, e25, e35, e45 */ other.group0(), /* e4235, e4315, e4125, e3215 */ self.group0())
    }
}
impl std::ops::Add<FlatPointAtInfinity> for Plane {
    type Output = Flector;
    fn add(self, other: FlatPointAtInfinity) -> Self::Output {
        Flector::from_groups(/* e15, e25, e35, e45 */ other.group0().with_w(0.0), /* e4235, e4315, e4125, e3215 */ self.group0())
    }
}
impl std::ops::Add<Flector> for Plane {
    ...
    fn add(self, other: Flector) -> Self::Output {
        Flector::from_groups(/* e15, e25, e35, e45 */ other.group0(), /* e4235, e4315, e4125, e3215 */ other.group1() + self.group0())
    }
}
...
impl std::ops::Add<Horizon> for Plane {
    ...
    fn add(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        Plane::from_groups(/* e4235, e4315, e4125, e3215 */ self.group0() + Simd32x3::from(0.0).with_w(other[e3215]))
    }
}
...
impl std::ops::Add<NullSphereAtOrigin> for Plane {
    ...
    fn add(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        Sphere::from_groups(/* e4235, e4315, e4125, e3215 */ self.group0(), /* e1234 */ other[e1234])
    }
}
...
impl std::ops::Add<Plane> for Plane {
    ...
    fn add(self, other: Plane) -> Self::Output {
        Plane::from_groups(/* e4235, e4315, e4125, e3215 */ other.group0() + self.group0())
    }
}
...
impl std::ops::Add<PlaneOnOrigin> for Plane {
    ...
    fn add(self, other: PlaneOnOrigin) -> Self::Output {
        use crate::elements::*;
        Plane::from_groups(/* e4235, e4315, e4125, e3215 */ (other.group0() + self.group0().xyz()).with_w(self[e3215]))
    }
}
...
impl std::ops::Add<Sphere> for Plane {
    ...
    fn add(self, other: Sphere) -> Self::Output {
        use crate::elements::*;
        Sphere::from_groups(/* e4235, e4315, e4125, e3215 */ self.group0() + other.group0(), /* e1234 */ other[e1234])
    }
}
...
impl std::ops::Add<SphereOnOrigin> for Plane {
    ...
    fn add(self, other: SphereOnOrigin) -> Self::Output {
        use crate::elements::*;
        Sphere::from_groups(/* e4235, e4315, e4125, e3215 */ self.group0() + other.group0().xyz().with_w(0.0), /* e1234 */ other[e1234])
    }
}
...
impl From<Horizon> for Plane {
    fn from(from_horizon: Horizon) -> Self {
        use crate::elements::*;
        Plane::from_groups(/* e4235, e4315, e4125, e3215 */ Simd32x3::from(0.0).with_w(from_horizon[e3215]))
    }
}

impl From<PlaneOnOrigin> for Plane {
    fn from(from_plane_on_origin: PlaneOnOrigin) -> Self {
        Plane::from_groups(/* e4235, e4315, e4125, e3215 */ from_plane_on_origin.group0().with_w(0.0))
    }
}
...
impl std::ops::Sub<FlatPoint> for Plane {
    ...
    fn sub(self, other: FlatPoint) -> Self::Output {
        Flector::from_groups(/* e15, e25, e35, e45 */ other.group0() * Simd32x4::from(-1.0), /* e4235, e4315, e4125, e3215 */ self.group0())
    }
}
...
impl std::ops::Sub<Horizon> for Plane {
    ...
    fn sub(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        Plane::from_groups(/* e4235, e4315, e4125, e3215 */ self.group0() + Simd32x3::from(0.0).with_w(other[e3215] * -1.0))
    }
}
...
impl std::ops::Sub<NullSphereAtOrigin> for Plane {
    ...
    fn sub(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        Sphere::from_groups(/* e4235, e4315, e4125, e3215 */ self.group0(), /* e1234 */ other[e1234] * -1.0)
    }
}
...
impl std::ops::Sub<Plane> for Plane {
    ...
    fn sub(self, other: Plane) -> Self::Output {
        Plane::from_groups(/* e4235, e4315, e4125, e3215 */ self.group0() - other.group0())
    }
}
...
impl std::ops::Sub<Sphere> for Plane {
    ...
    fn sub(self, other: Sphere) -> Self::Output {
        use crate::elements::*;
        Sphere::from_groups(/* e4235, e4315, e4125, e3215 */ self.group0() - other.group0(), /* e1234 */ other[e1234] * -1.0)
    }
}
...
impl TryFrom<AntiMotor> for Plane {
    ...
    fn try_from(anti_motor: AntiMotor) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ Simd32x3::from(0.0).with_w(anti_motor[e3215])))
    }
}
...
impl TryFrom<DipoleInversion> for Plane {
    ...
    fn try_from(dipole_inversion: DipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ dipole_inversion.group3()))
    }
}
...
impl TryFrom<DipoleInversionAligningOrigin> for Plane {
    ...
    fn try_from(dipole_inversion_aligning_origin: DipoleInversionAligningOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ dipole_inversion_aligning_origin.group2()))
    }
}
...
impl TryFrom<DipoleInversionAtInfinity> for Plane {
    ...
    fn try_from(dipole_inversion_at_infinity: DipoleInversionAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ dipole_inversion_at_infinity.group2()))
    }
}
...
impl TryFrom<DipoleInversionAtOrigin> for Plane {
    ...
    fn try_from(dipole_inversion_at_origin: DipoleInversionAtOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ Simd32x3::from(0.0).with_w(dipole_inversion_at_origin[e3215])))
    }
}
...
impl TryFrom<DipoleInversionOnOrigin> for Plane {
    ...
    fn try_from(dipole_inversion_on_origin: DipoleInversionOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ Simd32x4::from([
...
impl TryFrom<Flector> for Plane {
    ...
    fn try_from(flector: Flector) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ flector.group1()))
    }
}
...
impl TryFrom<FlectorAtInfinity> for Plane {
    ...
    fn try_from(flector_at_infinity: FlectorAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ Simd32x3::from(0.0).with_w(flector_at_infinity[e3215])))
    }
}
...
impl TryFrom<MysteryDipoleInversion> for Plane {
    ...
    fn try_from(mystery_dipole_inversion: MysteryDipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ mystery_dipole_inversion.group1().with_w(0.0)))
    }
}
...
impl TryFrom<Sphere> for Plane {
    ...
    fn try_from(sphere: Sphere) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ sphere.group0()))
    }
}
...
impl TryFrom<SphereAtOrigin> for Plane {
    ...
    fn try_from(sphere_at_origin: SphereAtOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ Simd32x3::from(0.0).with_w(sphere_at_origin[e3215])))
    }
}
...
impl TryFrom<SphereOnOrigin> for Plane {
    ...
    fn try_from(sphere_on_origin: SphereOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ sphere_on_origin.group0().xyz().with_w(0.0)))
    }
}
...
impl TryFrom<VersorOdd> for Plane {
    ...
    fn try_from(versor_odd: VersorOdd) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ versor_odd.group3()))
    }
}
...
impl TryFrom<VersorOddAtInfinity> for Plane {
    ...
    fn try_from(versor_odd_at_infinity: VersorOddAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ versor_odd_at_infinity.group2()))
    }
}
