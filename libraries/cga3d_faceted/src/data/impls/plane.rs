...
impl TryFrom<DipoleInversionOnOrigin> for Plane {
    ...
    fn try_from(dipole_inversion_on_origin: DipoleInversionOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ dipole_inversion_on_origin.group1().yzw().with_w(0.0)))
    }
}
...
impl TryFrom<FlectorOnOrigin> for Plane {
    ...
    fn try_from(flector_on_origin: FlectorOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ flector_on_origin.group0().yzw().with_w(0.0)))
    }
}
...
impl TryFrom<MysteryVersorOdd> for Plane {
    ...
    fn try_from(mystery_versor_odd: MysteryVersorOdd) -> Result<Self, Self::Error> {
        ...
        Ok(Plane::from_groups(/* e4235, e4315, e4125, e3215 */ mystery_versor_odd.group0().yzw().with_w(0.0)))
    }
}
