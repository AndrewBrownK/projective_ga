...
impl TryFrom<DipoleInversion> for FlectorAtInfinity {
    ...
    fn try_from(dipole_inversion: DipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorAtInfinity::from_groups(
            // e15, e25, e35, e3215
            dipole_inversion.group2().xyz().with_w(dipole_inversion[e3215]),
        ))
    }
}
...
impl TryFrom<DipoleInversionAligningOrigin> for FlectorAtInfinity {
    ...
    fn try_from(dipole_inversion_aligning_origin: DipoleInversionAligningOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorAtInfinity::from_groups(
            // e15, e25, e35, e3215
            dipole_inversion_aligning_origin.group1().xyz().with_w(dipole_inversion_aligning_origin[e3215]),
        ))
    }
}
...
impl TryFrom<DipoleInversionOrthogonalOrigin> for FlectorAtInfinity {
    ...
    fn try_from(dipole_inversion_orthogonal_origin: DipoleInversionOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorAtInfinity::from_groups(
            // e15, e25, e35, e3215
            dipole_inversion_orthogonal_origin.group2().xyz().with_w(dipole_inversion_orthogonal_origin[e3215]),
        ))
    }
}
...
impl TryFrom<Flector> for FlectorAtInfinity {
    ...
    fn try_from(flector: Flector) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorAtInfinity::from_groups(/* e15, e25, e35, e3215 */ flector.group0().xyz().with_w(flector[e3215])))
    }
}
...
impl TryFrom<VersorOdd> for FlectorAtInfinity {
    ...
    fn try_from(versor_odd: VersorOdd) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorAtInfinity::from_groups(/* e15, e25, e35, e3215 */ versor_odd.group2().xyz().with_w(versor_odd[e3215])))
    }
}
...
impl TryFrom<VersorOddAtInfinity> for FlectorAtInfinity {
    ...
    fn try_from(versor_odd_at_infinity: VersorOddAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorAtInfinity::from_groups(
            // e15, e25, e35, e3215
            versor_odd_at_infinity.group0().yzw().with_w(versor_odd_at_infinity[e3215]),
        ))
    }
}
