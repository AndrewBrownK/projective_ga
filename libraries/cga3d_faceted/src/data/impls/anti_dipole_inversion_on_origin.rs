...
impl std::ops::Add<AntiDipoleOnOrigin> for AntiDipoleInversionOnOrigin {
    ...
    fn add(self, other: AntiDipoleOnOrigin) -> Self::Output {
        AntiDipoleInversionOnOrigin::from_groups(/* e423, e431, e412, e321 */ self.group0() + other.group0(), /* e4, e1, e2, e3 */ self.group1())
    }
}
...
impl std::ops::Add<AntiSphereOnOrigin> for AntiDipoleInversionOnOrigin {
    ...
    fn add(self, other: AntiSphereOnOrigin) -> Self::Output {
        AntiDipoleInversionOnOrigin::from_groups(/* e423, e431, e412, e321 */ self.group0(), /* e4, e1, e2, e3 */ self.group1() + other.group0().wxyz())
    }
}
...
impl From<AntiDipoleOnOrigin> for AntiDipoleInversionOnOrigin {
    fn from(from_anti_dipole_on_origin: AntiDipoleOnOrigin) -> Self {
        AntiDipoleInversionOnOrigin::from_groups(/* e423, e431, e412, e321 */ from_anti_dipole_on_origin.group0(), /* e4, e1, e2, e3 */ Simd32x4::from(0.0))
    }
}
...
impl TryFrom<AntiDipoleInversion> for AntiDipoleInversionOnOrigin {
    ...
    fn try_from(anti_dipole_inversion: AntiDipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(AntiDipoleInversionOnOrigin::from_groups(
            // e423, e431, e412, e321
