...
impl From<MotorAtInfinity> for Motor {
    fn from(from_motor_at_infinity: MotorAtInfinity) -> Self {
        Motor::from_groups(/* e415, e425, e435, e12345 */ Simd32x4::from(0.0), /* e235, e315, e125, e5 */ from_motor_at_infinity.group0())
    }
}

impl From<MotorOnOrigin> for Motor {
    fn from(from_motor_on_origin: MotorOnOrigin) -> Self {
        Motor::from_groups(/* e415, e425, e435, e12345 */ from_motor_on_origin.group0(), /* e235, e315, e125, e5 */ Simd32x4::from(0.0))
    }
}
...
impl TryFrom<CircleRotorAtInfinity> for Motor {
    ...
    fn try_from(circle_rotor_at_infinity: CircleRotorAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(Motor::from_groups(
            // e415, e425, e435, e12345
            circle_rotor_at_infinity.group0().xyz().with_w(circle_rotor_at_infinity[e12345]),
            // e235, e315, e125, e5
...
impl TryFrom<MysteryCircleRotor> for Motor {
    ...
    fn try_from(mystery_circle_rotor: MysteryCircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(Motor::from_groups(
            // e415, e425, e435, e12345
            mystery_circle_rotor.group0().xyz().with_w(mystery_circle_rotor[e12345]),
            // e235, e315, e125, e5
            Simd32x4::from(0.0),
        ))
    }
...
impl TryFrom<MysteryVersorEven> for Motor {
    ...
    fn try_from(mystery_versor_even: MysteryVersorEven) -> Result<Self, Self::Error> {
        ...
        Ok(Motor::from_groups(
            // e415, e425, e435, e12345
            mystery_versor_even.group1().xyz().with_w(mystery_versor_even[e12345]),
            // e235, e315, e125, e5
            Simd32x4::from(0.0),
        ))
    }
...
impl TryFrom<VersorEvenAtInfinity> for Motor {
    ...
    fn try_from(versor_even_at_infinity: VersorEvenAtInfinity) -> Result<Self, Self::Error> {
        ...
        Ok(Motor::from_groups(
            // e415, e425, e435, e12345
            versor_even_at_infinity.group1().xyz().with_w(versor_even_at_infinity[e12345]),
            // e235, e315, e125, e5
