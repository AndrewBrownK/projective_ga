...
impl std::ops::Add<AntiLineOnOrigin> for FlectorOnOrigin {
    ...
    fn add(self, other: AntiLineOnOrigin) -> Self::Output {
        use crate::elements::*;
        MysteryDipoleInversion::from_groups(/* e23, e31, e12, e45 */ other.group0().with_w(self[e45]), /* e4235, e4315, e4125 */ self.group0().yzw())
    }
}
...
impl std::ops::Add<FlatOrigin> for FlectorOnOrigin {
    ...
    fn add(self, other: FlatOrigin) -> Self::Output {
        use crate::elements::*;
        FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([other[e45], 0.0, 0.0, 0.0]) + self.group0())
    }
}
...
impl std::ops::Add<FlectorOnOrigin> for FlectorOnOrigin {
    ...
    fn add(self, other: FlectorOnOrigin) -> Self::Output {
        FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ other.group0() + self.group0())
    }
}
...
impl std::ops::Add<Plane> for FlectorOnOrigin {
    ...
    fn add(self, other: Plane) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            Simd32x3::from(0.0).with_w(self[e45]),
            // e4235, e4315, e4125, e3215
            (other.group0().xyz() + self.group0().yzw()).with_w(other[e3215]),
        )
    }
}
...
impl std::ops::Add<VersorOdd> for FlectorOnOrigin {
    ...
    fn add(self, other: VersorOdd) -> Self::Output {
        ...
        VersorOdd::from_groups(
            ...
            other.group2(),
            // e4235, e4315, e4125, e3215
            (other.group3().xyz() + self.group0().yzw()).with_w(other[e3215]),
        )
    }
}
impl std::ops::Add<VersorOddAtInfinity> for FlectorOnOrigin {
    ...
    fn add(self, other: VersorOddAtInfinity) -> Self::Output {
        ...
        VersorOddAtInfinity::from_groups(
            ...
            other.group1().xyz().with_w(self[e45] + other[e45]),
            // e4235, e4315, e4125, e3215
            (other.group2().xyz() + self.group0().yzw()).with_w(other[e3215]),
        )
    }
}
...
impl From<FlatOrigin> for FlectorOnOrigin {
    fn from(from_flat_origin: FlatOrigin) -> Self {
        use crate::elements::*;
        FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([from_flat_origin[e45], 0.0, 0.0, 0.0]))
    }
}
...
impl std::ops::Sub<FlatOrigin> for FlectorOnOrigin {
    ...
    fn sub(self, other: FlatOrigin) -> Self::Output {
        use crate::elements::*;
        FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([other[e45] * -1.0, 0.0, 0.0, 0.0]) + self.group0())
    }
}
...
impl std::ops::Sub<FlectorOnOrigin> for FlectorOnOrigin {
    ...
    fn sub(self, other: FlectorOnOrigin) -> Self::Output {
        FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ self.group0() - other.group0())
    }
}
...
impl TryFrom<AntiCircleRotor> for FlectorOnOrigin {
    ...
    fn try_from(anti_circle_rotor: AntiCircleRotor) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorOnOrigin::from_groups(
            // e45, e4235, e4315, e4125
...
impl TryFrom<Dipole> for FlectorOnOrigin {
    ...
    fn try_from(dipole: Dipole) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([dipole[e45], 0.0, 0.0, 0.0])))
    }
}
...
impl TryFrom<DipoleInversion> for FlectorOnOrigin {
    ...
    fn try_from(dipole_inversion: DipoleInversion) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([
...
impl TryFrom<DipoleOnOrigin> for FlectorOnOrigin {
    ...
    fn try_from(dipole_on_origin: DipoleOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([dipole_on_origin[e45], 0.0, 0.0, 0.0])))
    }
}
...
impl TryFrom<FlatPoint> for FlectorOnOrigin {
    ...
    fn try_from(flat_point: FlatPoint) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([flat_point[e45], 0.0, 0.0, 0.0])))
    }
}
...
impl TryFrom<MysteryDipole> for FlectorOnOrigin {
    ...
    fn try_from(mystery_dipole: MysteryDipole) -> Result<Self, Self::Error> {
        ...
        Ok(FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([mystery_dipole[e45], 0.0, 0.0, 0.0])))
    }
}
