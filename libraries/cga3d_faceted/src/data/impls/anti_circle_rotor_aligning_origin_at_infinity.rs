...
impl std::ops::Add<FlatOrigin> for AntiCircleRotorAligningOriginAtInfinity {
    ...
    fn add(self, other: FlatOrigin) -> Self::Output {
        use crate::elements::*;
        AntiCircleRotorAtInfinity::from_groups(/* e23, e31, e12, e45 */ self.group0().with_w(other[e45]), /* e15, e25, e35, scalar */ self.group1())
    }
}
...
impl From<AntiLine> for AntiCircleRotorAligningOriginAtInfinity {
    fn from(from_anti_line: AntiLine) -> Self {
        AntiCircleRotorAligningOriginAtInfinity::from_groups(/* e23, e31, e12 */ from_anti_line.group0(), /* e15, e25, e35, scalar */ from_anti_line.group1().with_w(0.0))
    }
}
...
impl From<AntiLineOnOrigin> for AntiCircleRotorAligningOriginAtInfinity {
    fn from(from_anti_line_on_origin: AntiLineOnOrigin) -> Self {
        AntiCircleRotorAligningOriginAtInfinity::from_groups(/* e23, e31, e12 */ from_anti_line_on_origin.group0(), /* e15, e25, e35, scalar */ Simd32x4::from(0.0))
    }
}
...
impl std::ops::Sub<FlatOrigin> for AntiCircleRotorAligningOriginAtInfinity {
    ...
    fn sub(self, other: FlatOrigin) -> Self::Output {
        use crate::elements::*;
        AntiCircleRotorAtInfinity::from_groups(/* e23, e31, e12, e45 */ self.group0().with_w(other[e45] * -1.0), /* e15, e25, e35, scalar */ self.group1())
    }
}
...
impl TryFrom<AntiCircleOnOrigin> for AntiCircleRotorAligningOriginAtInfinity {
    ...
    fn try_from(anti_circle_on_origin: AntiCircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(AntiCircleRotorAligningOriginAtInfinity::from_groups(
            // e23, e31, e12
