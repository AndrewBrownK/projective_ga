...
impl RoundWeight for AntiDipoleInversionOnOrigin {
    ...
    fn round_weight(self) -> Self::Output {
        use crate::elements::*;
        NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ self.group0().xyz().with_w(self[e4]))
    }
}
...
impl RoundWeight for AntiVersorEvenOnOrigin {
    ...
    fn round_weight(self) -> Self::Output {
        use crate::elements::*;
        NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ self.group0().xyz().with_w(self[e1234]))
    }
}
