...
impl RoundBulk for AntiCircleRotor {
    ...
    fn round_bulk(self) -> Self::Output {
        use crate::elements::*;
        AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ self.group1().xyz().with_w(self[scalar]))
    }
}
...
impl RoundBulk for AntiCircleRotorAtInfinity {
    ...
    fn round_bulk(self) -> Self::Output {
        use crate::elements::*;
        AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ self.group0().xyz().with_w(self[scalar]))
    }
}
