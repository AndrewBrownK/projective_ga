...
impl AntiFix for AntiDipoleOnOrigin {
    ...
    fn anti_fix(self) -> Self {
        AntiDipoleOnOrigin::from_groups(/* e423, e431, e412, e321 */ (self.group0().xyz() * Simd32x3::from(-1.0) / self.group0().www()).with_w(-1.0))
    }
}
...
impl AntiFix for AntiFlectorOnOrigin {
    ...
    fn anti_fix(self) -> Self {
        ...
        AntiFlectorOnOrigin::from_groups(
            // e321, e1, e2, e3
            Simd32x4::from([
                f32::powi(self[e321], 3) - (self[e3] * self[e3] * self[e321]),
                (self[e321] * self[e321] * self[e1]) - f32::powi(self[e1], 3),
                (self[e321] * self[e321] * self[e2]) - f32::powi(self[e2], 3),
                (self[e321] * self[e321] * self[e3]) - f32::powi(self[e3], 3),
    ...
    fn anti_fix(self) -> Self {
        ...
        AntiLineOnOrigin::from_groups(
            ...
            (self.group0() * self.group0() * anti_reverse_g0)
                + (self.group0() * anti_reverse_g0.yxx() * self.group0().yxx())
                + (self.group0() * anti_reverse_g0.zzy() * self.group0().zzy()),
        )
    }
}
impl AntiFix for AntiMotorOnOrigin {
    ...
    fn anti_fix(self) -> Self {
        ...
        AntiMotorOnOrigin::from_groups(
            // e23, e31, e12, scalar
            Simd32x4::from([
                f32::powi(self[e23], 3) - (self[scalar] * self[scalar] * self[e23]),
                f32::powi(self[e31], 3) - (self[scalar] * self[scalar] * self[e31]),
                f32::powi(self[e12], 3) - (self[scalar] * self[scalar] * self[e12]),
                (self[e12] * self[e12] * self[scalar]) - f32::powi(self[scalar], 3),
...
impl AntiFix for DipoleOnOrigin {
    ...
    // no simd        0        0        3
    fn anti_fix(self) -> Self {
        DipoleOnOrigin::from_groups(/* e41, e42, e43, e45 */ (self.group0().xyz() / self.group0().www()).with_w(1.0))
    }
}
...
impl AntiFix for FlectorOnOrigin {
    ...
    fn anti_fix(self) -> Self {
        ...
        FlectorOnOrigin::from_groups(
            ...
            Simd32x4::from([
                (self[e4125] * self[e4125] * self[e45]) - f32::powi(self[e45], 3),
                f32::powi(self[e4235], 3) - (self[e45] * self[e45] * self[e4235]),
                f32::powi(self[e4315], 3) - (self[e45] * self[e45] * self[e4315]),
                f32::powi(self[e4125], 3) - (self[e45] * self[e45] * self[e4125]),
            ]) + (Simd32x4::powi(self.group0().yzwy(), 2) * self.group0())
                + (Simd32x4::powi(self.group0().zwyz(), 2) * self.group0()),
        )
    }
...
impl AntiFix for MotorOnOrigin {
    ...
    fn anti_fix(self) -> Self {
        ...
        MotorOnOrigin::from_groups(
            ...
            Simd32x4::from([
                (self[e12345] * self[e12345] * self[e415]) - f32::powi(self[e415], 3),
                (self[e12345] * self[e12345] * self[e425]) - f32::powi(self[e425], 3),
                (self[e12345] * self[e12345] * self[e435]) - f32::powi(self[e435], 3),
                f32::powi(self[e12345], 3) - (self[e435] * self[e435] * self[e12345]),
            ]) - (Simd32x4::powi(self.group0().yzxx(), 2) * self.group0())
                - (Simd32x4::powi(self.group0().zxyy(), 2) * self.group0()),
        )
    }
