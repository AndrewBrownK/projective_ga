...
impl Carrier for AntiCircleRotorAligningOriginAtInfinity {
    ...
    fn carrier(self) -> Self::Output {
        use crate::elements::*;
        MotorAtInfinity::from_groups(/* e235, e315, e125, e5 */ Simd32x4::from([self[e23], self[e31], self[e12], self[scalar]]))
    }
}
...
impl Carrier for DipoleInversionAligningOrigin {
    ...
    fn carrier(self) -> Self::Output {
        use crate::elements::*;
        MotorOnOrigin::from_groups(/* e415, e425, e435, e12345 */ Simd32x4::from([self[e41], self[e42], self[e43], self[e1234]]))
    }
}
