...
impl Support for AntiCircleRotor {
    ...
    fn support(self) -> Self::Output {
        use crate::elements::*;
        SphereOnOrigin::from_groups(/* e4235, e4315, e4125, e1234 */ Simd32x4::from([self[e15], self[e25], self[e35], self[e45]]))
    }
}
...
impl Support for DipoleInversion {
    ...
    fn support(self) -> Self::Output {
        ...
        DipoleInversionOnOrigin::from_groups(
            ...
            Simd32x4::from([self[e45], self[e15], self[e25], self[e35]]),
        )
    }
}
...
impl Support for DipoleInversionAtOrigin {
    ...
    fn support(self) -> Self::Output {
        ...
        FlectorOnOrigin::from_groups(
            ...
            Simd32x4::from([self[e3215], self[e15], self[e25], self[e35]]) * Simd32x4::from([1.0, -1.0, -1.0, -1.0]),
        )
    }
}
impl Support for DipoleInversionOnOrigin {
    ...
    fn support(self) -> Self::Output {
        use crate::elements::*;
        NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x4::from([self[e4235], self[e4315], self[e4125], self[e45]]))
    }
}
impl Support for DipoleInversionOrthogonalOrigin {
    ...
    fn support(self) -> Self::Output {
        use crate::elements::*;
        FlectorOnOrigin::from_groups(/* e45, e4235, e4315, e4125 */ Simd32x4::from([self[e3215], self[e15], self[e25], self[e35]]))
    }
}
...
impl Support for MultiVector {
    ...
    fn support(self) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e12345
            Simd32x2::from([0.0, self[e5]]) * Simd32x2::from([0.0, -1.0]),
            // e1, e2, e3, e4
...
impl Support for VersorEvenAtOrigin {
    ...
    fn support(self) -> Self::Output {
        use crate::elements::*;
        MotorOnOrigin::from_groups(/* e415, e425, e435, e12345 */ self.group1().xyz().with_w(self[e5] * -1.0))
    }
}
...
impl Support for VersorOddAtInfinity {
    ...
    fn support(self) -> Self::Output {
        ...
        DipoleInversionOnOrigin::from_groups(
            // e41, e42, e43, e45
            Simd32x4::from([self[e4235] * -1.0, self[e4315] * -1.0, self[e4125], self[e3215]]) * Simd32x4::from([-1.0, -1.0, 1.0, 1.0]),
            // e1234, e4235, e4315, e4125
            Simd32x4::from([self[e45], right_anti_dual_g2_xyz[0], right_anti_dual_g2_xyz[1], right_anti_dual_g2_xyz[2]]),
        )
    }
