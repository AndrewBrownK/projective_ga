...
impl CoCarrier for DipoleInversionAtInfinity {
    ...
    fn co_carrier(self) -> Self::Output {
        use crate::elements::*;
        FlectorAtInfinity::from_groups(/* e15, e25, e35, e3215 */ (self.group2().xyz() * Simd32x3::from(-1.0)).with_w(self[e45]))
    }
}
...
impl CoCarrier for DualNum {
    ...
    fn co_carrier(self) -> Self::Output {
        ...
        Motor::from_groups(
            // e415, e425, e435, e12345
            Simd32x3::from(0.0).with_w(self[e4] * -1.0),
            // e235, e315, e125, e5
...
impl CoCarrier for Flector {
    ...
    fn co_carrier(self) -> Self::Output {
        use crate::elements::*;
        FlectorAtInfinity::from_groups(/* e15, e25, e35, e3215 */ (self.group1().xyz() * Simd32x3::from(-1.0)).with_w(self[e45]))
    }
}
...
impl CoCarrier for MysteryVersorOdd {
    ...
    fn co_carrier(self) -> Self::Output {
        use crate::elements::*;
        FlectorAtInfinity::from_groups(/* e15, e25, e35, e3215 */ (self.group0().yzw() * Simd32x3::from(-1.0)).with_w(self[e45]))
    }
}
...
impl CoCarrier for VersorOdd {
    ...
    fn co_carrier(self) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            (self.group3().xyz() * Simd32x3::from(-1.0)).with_w(self[e1234]),
            // e4235, e4315, e4125, e3215
            (self.group0().xyz() * Simd32x3::from(-1.0)).with_w(self[e45]),
        )
    }
}
