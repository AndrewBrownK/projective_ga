...
impl GeometricAntiProduct<Line> for Flector {
    ...
    fn geometric_anti_product(self, other: Line) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            // e423, e431, e412, e321
            (self.group1().yzxy() * other.group0().zxy().with_w(other[e31]))
...
impl GeometricAntiProduct<MultiVector> for Flector {
    ...
    fn geometric_anti_product(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            (self.group1().xyxy() * other.group0().yy().with_zw(other[e42], other[e31]))
...
impl GeometricAntiProduct<MultiVector> for Horizon {
    ...
    fn geometric_anti_product(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([self[e321] * other[e4], 0.0]) * Simd32x2::from([-1.0, 0.0]),
            // e1, e2, e3, e4
...
impl GeometricAntiProduct<MultiVector> for Line {
    ...
    fn geometric_anti_product(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (self.group0().xyx() * other.group0().yy().with_z(other[e42])) + (self.group0().yzz() * other.group2().zx().with_z(other[e1234]))
...
impl GeometricAntiProduct<Line> for MultiVector {
    ...
    fn geometric_anti_product(self, other: Line) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (Simd32x3::from([self[e1234], self[e43], self[e41]]) * other.group0().xxy()) + (Simd32x3::from([self[e42], self[e1234], self[e1234]]) * other.group0().zyz())
            ...
            // e423, e431, e412, e321
            (Simd32x4::from([self[e4], self[e412], self[e423], other[e23] * self[e423]]) * other.group0().xxy().with_w(1.0))
