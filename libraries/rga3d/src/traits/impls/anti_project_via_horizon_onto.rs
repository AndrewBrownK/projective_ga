...
impl AntiProjectViaHorizonOnto<Motor> for DualNum {
    ...
    fn anti_project_via_horizon_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge_g1_w = right_dual_g0[3] * self[scalar];
        Motor::from_groups(
            // e41, e42, e43, e1234
...
impl AntiProjectViaHorizonOnto<Flector> for Flector {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge_g0_xyz = (right_dual_g1_xyz.yzx() * self.group1().zxy()) - (right_dual_g1_xyz.zxy() * self.group1().yzx());
        let anti_wedge_g1_xyz = right_dual_g1_xyz * Simd32x3::from(self[e321] * -1.0);
        let anti_wedge_g1_w = (right_dual_g1_xyz[0] * self[e1]) + (right_dual_g1_xyz[1] * self[e2]) + (right_dual_g1_xyz[2] * self[e3]) + (other[e321] * self[e321]);
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(anti_wedge_g1_w) * other.group0(),
            // e423, e431, e412, e321
...
impl AntiProjectViaHorizonOnto<Line> for Flector {
    ...
    fn anti_project_via_horizon_onto(self, other: Line) -> Self::Output {
        ...
        let anti_wedge_g0_w = -(right_dual_g0[0] * self[e423]) - (right_dual_g0[1] * self[e431]) - (right_dual_g0[2] * self[e412]);
        Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([
...
impl AntiProjectViaHorizonOnto<MultiVector> for Flector {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge_g1 = Simd32x4::from([
            ...
            -(right_dual_g2[0] * self[e423]) - (right_dual_g2[1] * self[e431]) - (right_dual_g2[2] * self[e412]),
        ]) + (right_dual_g2 * Simd32x3::from(self[e321])).with_w(self[e4] * other[scalar]);
        let anti_wedge_g2 = (right_dual_g4_xyz.yzx() * self.group1().zxy()) - (right_dual_g4_xyz.zxy() * self.group1().yzx());
        let anti_wedge_g3 = Simd32x3::from([right_dual_g4_xyz[0] * self[e321], right_dual_g4_xyz[1] * self[e321], right_dual_g4_xyz[2] * self[e321]]) * Simd32x3::from(-1.0);
...
impl AntiProjectViaHorizonOnto<Point> for Flector {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        ...
        let anti_wedge_g0_xyz = (right_dual_g0_xyz.yzx() * self.group1().zxy()) - (right_dual_g0_xyz.zxy() * self.group1().yzx());
...
impl AntiProjectViaHorizonOnto<Flector> for Line {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        ...
        let right_dual_g1_xyz = other.group0().xyz();
        let anti_wedge_g0 = Simd32x4::from([
            right_dual_g1_xyz[2] * self[e31],
            right_dual_g1_xyz[0] * self[e12],
            right_dual_g1_xyz[1] * self[e23],
            -(right_dual_g1_xyz[1] * self[e42]) - (right_dual_g1_xyz[2] * self[e43]),
...
impl AntiProjectViaHorizonOnto<MultiVector> for Line {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge_g1 = Simd32x4::from([
            right_dual_g4_xyz[2] * self[e31],
            right_dual_g4_xyz[0] * self[e12],
            right_dual_g4_xyz[1] * self[e23],
            -(right_dual_g4_xyz[1] * self[e42]) - (right_dual_g4_xyz[2] * self[e43]),
...
impl AntiProjectViaHorizonOnto<Point> for Line {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        ...
        let right_dual_g0_xyz = other.group0().xyz();
        let anti_wedge_g0 = Simd32x4::from([
            right_dual_g0_xyz[2] * self[e31],
            right_dual_g0_xyz[0] * self[e12],
            right_dual_g0_xyz[1] * self[e23],
            -(right_dual_g0_xyz[1] * self[e42]) - (right_dual_g0_xyz[2] * self[e43]),
...
impl AntiProjectViaHorizonOnto<Flector> for Motor {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge_g0 = Simd32x4::from([
            ...
            right_dual_g1_xyz[0] * self[e12],
            right_dual_g1_xyz[1] * self[e23],
            -(right_dual_g1_xyz[1] * self[e42]) - (right_dual_g1_xyz[2] * self[e43]) - (other[e321] * self[e1234]),
        ]) - (right_dual_g1_xyz.yzx() * self.group1().zxy()).with_w(right_dual_g1_xyz[0] * self[e41]);
...
impl AntiProjectViaHorizonOnto<MultiVector> for Motor {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let right_dual_g2 = other.group3() * Simd32x3::from(-1.0);
        let right_dual_g4_xyz = other.group1().xyz();
        let anti_wedge_g0_x = (self[scalar] * other[scalar]) - (right_dual_g2[0] * self[e23]) - (right_dual_g2[1] * self[e31]) - (right_dual_g2[2] * self[e12]);
        let anti_wedge_g1 = Simd32x4::from([
            right_dual_g4_xyz[2] * self[e31],
            right_dual_g4_xyz[0] * self[e12],
            right_dual_g4_xyz[1] * self[e23],
            -(right_dual_g4_xyz[1] * self[e42]) - (right_dual_g4_xyz[2] * self[e43]) - (self[e1234] * other[e321]),
        ]) - (right_dual_g4_xyz.yzx() * self.group1().zxy()).with_w(right_dual_g4_xyz[0] * self[e41]);
        ...
        let anti_wedge_g4_xyz = right_dual_g4_xyz * Simd32x3::from(self[e1234]);
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                anti_wedge_g0_x * other[scalar],
...
impl AntiProjectViaHorizonOnto<Flector> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        ...
        let right_dual_g1_xyz = other.group0().xyz();
        let anti_wedge_g0_x = (right_dual_g1_xyz[0] * self[e1]) + (right_dual_g1_xyz[1] * self[e2]) + (right_dual_g1_xyz[2] * self[e3]) - (right_dual_g0_w * self[e321]);
        let anti_wedge_g1 = Simd32x3::from(0.0).with_w(-(right_dual_g1_xyz[1] * self[e42]) - (right_dual_g1_xyz[2] * self[e43]))
            + (right_dual_g1_xyz.zxy() * self.group3().yzx()).with_w(right_dual_g0_w * self[e1234])
        ...
        let anti_wedge_g3_x = right_dual_g1_xyz[0] * self[e321] * -1.0;
        let anti_wedge_g3_y = right_dual_g1_xyz[1] * self[e321] * -1.0;
        let anti_wedge_g3_z = right_dual_g1_xyz[2] * self[e321] * -1.0;
...
impl AntiProjectViaHorizonOnto<Line> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: Line) -> Self::Output {
        ...
        let anti_wedge_g1_w = -(right_dual_g0[0] * self[e423]) - (right_dual_g0[1] * self[e431]) - (right_dual_g0[2] * self[e412]);
...
impl AntiProjectViaHorizonOnto<Motor> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: Motor) -> Self::Output {
        use crate::elements::*;
        let right_dual_g0 = other.group1() * Simd32x4::from([-1.0, -1.0, -1.0, 1.0]);
        let anti_wedge_g0_x = (right_dual_g0[3] * self[scalar]) - (right_dual_g0[0] * self[e23]) - (right_dual_g0[1] * self[e31]) - (right_dual_g0[2] * self[e12]);
        let anti_wedge_g1 = Simd32x4::from([
            right_dual_g0[3] * self[e1],
            right_dual_g0[3] * self[e2],
            right_dual_g0[3] * self[e3],
        ...
        let anti_wedge_g2 = (Simd32x3::from(right_dual_g0[3]) * self.group2()) + (Simd32x3::from(self[e1234]) * right_dual_g0.xyz());
        ...
        MultiVector::from_groups(
            ...
            Simd32x2::from([
                anti_wedge_g0_x * other[scalar],
                (anti_wedge_g0_x * other[e1234]) + (right_dual_g0[3] * other[scalar] * self[e1234])
                    - (anti_wedge_g2[0] * other[e23])
                    - (anti_wedge_g2[1] * other[e31])
                    - (anti_wedge_g2[2] * other[e12])
                    - (anti_wedge_g3[0] * other[e41])
...
impl AntiProjectViaHorizonOnto<MultiVector> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge_g0_x =
            (right_dual_g4[0] * self[e1]) + (right_dual_g4[1] * self[e2]) + (right_dual_g4[2] * self[e3]) + (right_dual_g4[3] * self[e4]) + (other[scalar] * self[scalar])
                - (right_dual_g1_w * self[e321])
                - (right_dual_g2[0] * self[e23])
                - (right_dual_g2[1] * self[e31])
                - (right_dual_g2[2] * self[e12]);
        let anti_wedge_g1 = Simd32x4::from([
            (right_dual_g4[3] * self[e41]) + (other[scalar] * self[e1]),
            (right_dual_g4[3] * self[e42]) + (other[scalar] * self[e2]),
            (right_dual_g4[3] * self[e43]) + (other[scalar] * self[e3]),
            -(right_dual_g2[1] * self[e431]) - (right_dual_g2[2] * self[e412]) - (right_dual_g4[0] * self[e41]) - (right_dual_g4[1] * self[e42]) - (right_dual_g4[2] * self[e43]),
        ]) + (right_dual_g2 * Simd32x3::from(self[e321])).with_w(right_dual_g1_w * self[e1234])
            + (self.group3().yzx() * right_dual_g4.zxy()).with_w(other[scalar] * self[e4])
            - (self.group3().zxy() * right_dual_g4.yzx()).with_w(right_dual_g2[0] * self[e423]);
        let anti_wedge_g2 = (right_dual_g2 * Simd32x3::from(self[e1234])) + (Simd32x3::from(other[scalar]) * self.group2()) + (right_dual_g4.yzx() * self.group4().zxy())
            - (right_dual_g4.zxy() * self.group4().yzx());
        let anti_wedge_g3 =
            (Simd32x3::from(right_dual_g4[3]) * self.group4().xyz()) + (Simd32x3::from(other[scalar]) * self.group3()) - (Simd32x3::from(self[e321]) * right_dual_g4.xyz());
...
impl AntiProjectViaHorizonOnto<Point> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        ...
        let anti_wedge_g3_x = right_dual_g0_xyz[0] * self[e321] * -1.0;
        let anti_wedge_g3_y = right_dual_g0_xyz[1] * self[e321] * -1.0;
        let anti_wedge_g3_z = right_dual_g0_xyz[2] * self[e321] * -1.0;
...
impl AntiProjectViaHorizonOnto<Flector> for Plane {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        use crate::elements::*;
        let right_dual_g1_xyz = other.group0().xyz();
        let anti_wedge_g0_xyz = (right_dual_g1_xyz.yzx() * self.group0().zxy()) - (right_dual_g1_xyz.zxy() * self.group0().yzx());
        let anti_wedge_g1_x = right_dual_g1_xyz[0] * self[e321] * -1.0;
        let anti_wedge_g1_y = right_dual_g1_xyz[1] * self[e321] * -1.0;
        let anti_wedge_g1_z = right_dual_g1_xyz[2] * self[e321] * -1.0;
