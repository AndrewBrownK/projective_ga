...
impl AntiProjectViaHorizonOnto<Flector> for Flector {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge_g1_w = (right_dual_g1_xyz[0] * self[e1]) + (other[e321] * self[e321]);
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(anti_wedge_g1_w) * other.group0(),
            // e423, e431, e412, e321
            ((Simd32x3::from(anti_wedge_g1_w) * other.group1().xyz()) + (anti_wedge_g0_xyz.yzx() * other.group0().zxy())
                - (right_dual_g1_xyz * Simd32x3::from(other[e4] * self[e321]))
...
impl AntiProjectViaHorizonOnto<MultiVector> for Flector {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge_g3 = right_dual_g4_xyz * Simd32x3::from(self[e321] * -1.0);
...
impl AntiProjectViaHorizonOnto<Point> for Flector {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            // e423, e431, e412, e321
            ((anti_wedge_g0_xyz.yzx() * other.group0().zxy()) - (right_dual_g0_xyz * Simd32x3::from(self[e321] * other[e4])) - (anti_wedge_g0_xyz.zxy() * other.group0().yzx()))
                .with_w(0.0),
        )
    }
}
...
impl AntiProjectViaHorizonOnto<Flector> for Line {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        use crate::elements::*;
        let right_dual_g1_xyz = other.group0().xyz();
        let anti_wedge_g0_xyz = (right_dual_g1_xyz.zxy() * self.group1().yzx()) - (right_dual_g1_xyz.yzx() * self.group1().zxy());
        Motor::from_groups(
            // e41, e42, e43, e1234
...
impl AntiProjectViaHorizonOnto<MultiVector> for Line {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge_g1 = ((right_dual_g4_xyz.zxy() * self.group1().yzx()) - (right_dual_g4_xyz.yzx() * self.group1().zxy())).with_w(0.0);
...
impl AntiProjectViaHorizonOnto<Point> for Line {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let right_dual_g0_xyz = other.group0().xyz();
        let anti_wedge_g0_xyz = (right_dual_g0_xyz.zxy() * self.group1().yzx()) - (right_dual_g0_xyz.yzx() * self.group1().zxy());
        Line::from_groups(
            // e41, e42, e43
...
impl AntiProjectViaHorizonOnto<Flector> for Motor {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (other.group0().xyzx() * Simd32x3::from(other[e321] * self[e1234]).with_w(right_dual_g1_xyz[0] * self[e1234]))
...
impl AntiProjectViaHorizonOnto<MultiVector> for Motor {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge_g1 = ((right_dual_g4_xyz.zxy() * self.group1().yzx()) - (right_dual_g4_xyz.yzx() * self.group1().zxy())).with_w(self[e1234] * other[e321] * -1.0);
        ...
        let anti_wedge_g4 = (right_dual_g4_xyz * Simd32x4::from(self[e1234]).xyz()).with_w(0.0);
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                anti_wedge_g0_x * other[scalar],
...
impl AntiProjectViaHorizonOnto<Point> for Motor {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (anti_wedge_g0_xyz * Simd32x4::from(other[e4]).xyz()).with_w(right_dual_g0_xyz[0] * self[e1234] * other[e1]),
            // e23, e31, e12, scalar
            ((anti_wedge_g0_xyz.zxy() * other.group0().yzx()) - (anti_wedge_g0_xyz.yzx() * other.group0().zxy())).with_w(0.0),
        )
    }
...
impl AntiProjectViaHorizonOnto<Flector> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge_g1_xyz = (right_dual_g1_xyz.zxy() * self.group3().yzx()) - (right_dual_g1_xyz.yzx() * self.group3().zxy());
        let anti_wedge_g1_w = right_dual_g0_w * self[e1234];
        let anti_wedge_g2 = (right_dual_g1_xyz.yzx() * self.group4().zxy()) - (right_dual_g1_xyz.zxy() * self.group4().yzx());
        let anti_wedge_g4 = Simd32x4::from([1.0, 1.0, self[e1234], 0.0]) * (right_dual_g1_xyz * Simd32x2::from(self[e1234]).with_z(1.0)).with_w(0.0);
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                0.0,
...
impl AntiProjectViaHorizonOnto<MultiVector> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge_g1 = (right_dual_g1 * Simd32x4::from(self[e1234]))
            ...
            + ((right_dual_g2 * Simd32x3::from(self[e321])) + (Simd32x3::from(right_dual_g4[3]) * self.group2()) + (self.group3().yzx() * right_dual_g4.zxy())
                - (self.group3().zxy() * right_dual_g4.yzx()))
            .with_w(0.0);
        let anti_wedge_g2 = Simd32x3::from([
            (right_dual_g4[1] * self[e412]) - (right_dual_g4[2] * self[e431]),
            (right_dual_g4[2] * self[e423]) - (right_dual_g4[0] * self[e412]),
            (right_dual_g4[0] * self[e431]) - (right_dual_g4[1] * self[e423]),
        ]) + (right_dual_g2 * Simd32x3::from(self[e1234]))
...
impl AntiProjectViaHorizonOnto<Point> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let right_dual_g0_xyz = other.group0().xyz();
        let anti_wedge_g1_xyz = (right_dual_g0_xyz.zxy() * self.group3().yzx()) - (right_dual_g0_xyz.yzx() * self.group3().zxy());
        let anti_wedge_g2 = (right_dual_g0_xyz.yzx() * self.group4().zxy()) - (right_dual_g0_xyz.zxy() * self.group4().yzx());
        let anti_wedge_g4 = Simd32x4::from([1.0, 1.0, self[e1234], 0.0]) * (right_dual_g0_xyz * Simd32x2::from(self[e1234]).with_z(1.0)).with_w(0.0);
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                0.0,
            ...
            (anti_wedge_g1_xyz.zxy() * other.group0().yzx()) - (anti_wedge_g1_xyz.yzx() * other.group0().zxy()),
            // e423, e431, e412, e321
            ((anti_wedge_g2.yzx() * other.group0().zxy()) - (right_dual_g0_xyz * Simd32x3::from(self[e321] * other[e4])) - (anti_wedge_g2.zxy() * other.group0().yzx()))
                .with_w(0.0),
        )
    }
}
...
impl AntiProjectViaHorizonOnto<Point> for Plane {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        ...
        Plane::from_groups(
            // e423, e431, e412, e321
            ((anti_wedge_g0.yzx() * other.group0().zxy()) - (right_dual_g0_xyz * Simd32x3::from(self[e321] * other[e4])) - (anti_wedge_g0.zxy() * other.group0().yzx()))
                .with_w(0.0),
        )
    }
}
