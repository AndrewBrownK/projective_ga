    ...
    fn anti_sandwich(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            Simd32x4::from([
                ...
                self[e1234],
                self[e1234],
                (geometric_anti_product_g1[3] * self[e1234]) - (geometric_anti_product_g0_w * self[scalar]),
    ...
    fn anti_sandwich(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                self[e1234],
                self[e1234],
                (geometric_anti_product_g4[3] * self[e1234]) - (geometric_anti_product_g1_w * self[scalar]),
    ...
    fn anti_sandwich(self, other: DualNum) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            (Simd32x4::from(geometric_anti_product_g0_w) * self.group0().xyz().with_w(self[e321]))
                ...
                + (self.group0().zx().with_zw(self[e321], geometric_anti_product_g0_xyz[2] * self[e412]) * geometric_anti_product_g1.yzz().with_w(1.0))
                + (self.group1().ww().with_zw(self[e2], geometric_anti_product_g0_xyz[1] * self[e431]) * geometric_anti_product_g1.xyx().with_w(1.0))
                - (Simd32x4::from(geometric_anti_product_g1[3]) * self.group1().xyz().with_w(self[e4]))
                - (geometric_anti_product_g1.zxyz() * self.group0().yzxz())
                - (self.group0().ww().with_zw(self[e431], geometric_anti_product_g1[0] * self[e1]) * geometric_anti_product_g0_xyz.xyx().with_w(1.0))
                - (self.group1().zx().with_zw(self[e4], geometric_anti_product_g1[1] * self[e2]) * geometric_anti_product_g0_xyz.yzz().with_w(1.0)),
        )
    }
}
...
impl AntiSandwich<Line> for Flector {
    ...
    fn anti_sandwich(self, other: Line) -> Self::Output {
        ...
        let geometric_anti_product_g0 = Simd32x4::from([
            ...
            - (other.group1() * self.group0().www()).with_w(self[e431] * other[e42])
        ...
        let geometric_anti_product_g1 = (self.group1().yzxy() * other.group0().zxy().with_w(other[e31]))
            ...
            + (other.group0() * self.group0().www()).with_w(self[e423] * other[e23])
        ...
        Line::from_groups(
            ...
            (Simd32x3::from(geometric_anti_product_g0[3]) * self.group0().xyz())
                + (Simd32x3::from([self[e3], self[e1], self[e321]]) * geometric_anti_product_g1.yzz())
                + (Simd32x3::from([self[e321], self[e321], self[e2]]) * geometric_anti_product_g1.xyx())
...
impl AntiSandwich<MultiVector> for Flector {
    ...
    fn anti_sandwich(self, other: MultiVector) -> Self::Output {
        ...
        let geometric_anti_product_g1 = Simd32x4::from([
            ...
            (self[e3] * other[e1234]) + (self[e431] * other[e23]) + (self[e321] * other[e43]) - (self[e412] * other[scalar]),
            0.0,
        ]) + (self.group0().xyxw() * other.group0().yy().with_zw(other[e42], other[e1234]))
            - (self.group1().xyxz() * other.group0().xx().with_zw(other[e31], other[e43]))
            - (other.group3() * self.group0().www()).with_w(self[e431] * other[e42])
        ...
        let geometric_anti_product_g4 = (self.group1().xyxy() * other.group0().yy().with_zw(other[e42], other[e31]))
            + (self.group1().yzzz() * other.group2().zx().with_zw(other[e1234], other[e12]))
            + Simd32x3::from(0.0).with_w((self[e321] * other[e1234]) - (self[e2] * other[e42]) - (self[e3] * other[e43]) - (self[e4] * other[scalar]))
            + (other.group2() * self.group0().www()).with_w(self[e423] * other[e23])
        ...
        MultiVector::from_groups(
            ...
            ]) + (geometric_anti_product_g0.xx().with_zw(geometric_anti_product_g0[0], geometric_anti_product_g0[1] * self[e4]) * self.group1().xyz().with_w(1.0))
            ...
            (Simd32x3::from(geometric_anti_product_g1[3]) * self.group0().xyz())
                + (Simd32x3::from([self[e3], self[e1], self[e321]]) * geometric_anti_product_g4.yzz())
                + (Simd32x3::from([self[e321], self[e321], self[e2]]) * geometric_anti_product_g4.xyx())
                + (geometric_anti_product_g1.zxy() * self.group1().yzx())
            ...
            ]) + (geometric_anti_product_g0.yy().with_zw(geometric_anti_product_g0[1], geometric_anti_product_g0[0] * self[e4]) * self.group1().xyz().with_w(1.0))
    ...
    fn anti_sandwich(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            Simd32x4::from([
                ...
                - (self.group1() * geometric_anti_product_g0.www()).with_w(geometric_anti_product_g1[1] * self[e42])
            ...
            (geometric_anti_product_g1.yzxy() * self.group0().zxy().with_w(self[e31]))
                ...
                + (self.group0() * geometric_anti_product_g0.www()).with_w(geometric_anti_product_g1[0] * self[e23])
...
impl AntiSandwich<MultiVector> for Line {
    ...
    fn anti_sandwich(self, other: MultiVector) -> Self::Output {
        ...
        let geometric_anti_product_g2 = (self.group0().xyx() * other.group0().yy().with_z(other[e42])) + (self.group0().yzz() * other.group2().zx().with_z(other[e1234]))
            - (self.group0().zxy() * other.group2().yzx());
        let geometric_anti_product_g3 = (self.group0().xyx() * other.group0().xx().with_z(other[e31]))
            + (self.group0().yzz() * other.group3().zx().with_z(other[scalar]))
            + (self.group1().xyx() * other.group0().yy().with_z(other[e42]))
...
impl AntiSandwich<Point> for Line {
    ...
    fn anti_sandwich(self, other: Point) -> Self::Output {
        ...
        let geometric_anti_product_g1 =
            Simd32x4::from([other[e4], other[e4], other[e4], -(self[e41] * other[e1]) - (self[e42] * other[e2]) - (self[e43] * other[e3])]) * self.group0().with_w(1.0);
        Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (geometric_anti_product_g0[1] * self[e43]) + (geometric_anti_product_g1[2] * self[e31]) + (geometric_anti_product_g1[3] * self[e41]),
    ...
    fn anti_sandwich(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            Simd32x4::from([
                ...
                - (self.group1().xyz() * geometric_anti_product_g0.www()).with_w(geometric_anti_product_g1[1] * self[e42]),
            // e423, e431, e412, e321
            (geometric_anti_product_g1.xyxy() * self.group0().wwy().with_w(self[e31]))
                ...
                + (self.group0().xyz() * geometric_anti_product_g0.www()).with_w(geometric_anti_product_g1[0] * self[e23])
...
impl AntiSandwich<MultiVector> for Motor {
    ...
    fn anti_sandwich(self, other: MultiVector) -> Self::Output {
        ...
        let geometric_anti_product_g1 = Simd32x4::from([
            ...
            - (other.group4().yzxy() * self.group1().zxy().with_w(self[e42]));
        let geometric_anti_product_g2 = (Simd32x3::from(self[e1234]) * other.group2())
            + (self.group0().xyx() * other.group0().yy().with_z(other[e42]))
        ...
        let geometric_anti_product_g3 = (Simd32x3::from(self[e1234]) * other.group3())
            ...
            + (self.group0().xyx() * other.group0().xx().with_z(other[e31]))
            + (self.group0().yzz() * other.group3().zx().with_z(other[scalar]))
            + (self.group1().xyx() * other.group0().yy().with_z(other[e42]))
            + (self.group1().yzz() * other.group2().zx().with_z(other[e1234]))
        ...
        MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                - (self.group1().xyz() * geometric_anti_product_g1.www()).with_w(geometric_anti_product_g4[1] * self[e42]),
            // e41, e42, e43
            ...
            (geometric_anti_product_g4.xyxy() * self.group0().wwy().with_w(self[e31]))
                ...
                + (self.group0().xyz() * geometric_anti_product_g1.www()).with_w(geometric_anti_product_g4[0] * self[e23])
...
impl AntiSandwich<Point> for Motor {
    ...
    fn anti_sandwich(self, other: Point) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (geometric_anti_product_g0_xyz[1] * self[e43]) + (geometric_anti_product_g1[2] * self[e31]) + (geometric_anti_product_g1[3] * self[e41])
                    - (geometric_anti_product_g1[1] * self[e12]),
                (geometric_anti_product_g0_xyz[2] * self[e41]) + (geometric_anti_product_g1[0] * self[e12]) + (geometric_anti_product_g1[3] * self[e42])
                    - (geometric_anti_product_g1[2] * self[e23]),
                (geometric_anti_product_g0_xyz[2] * self[e1234]) + (geometric_anti_product_g1[1] * self[e23]) + (geometric_anti_product_g1[3] * self[e43])
                    - (geometric_anti_product_g1[2] * self[scalar]),
                0.0,
            ]) + (self.group0().wwyw() * geometric_anti_product_g0_xyz.xyx().with_w(geometric_anti_product_g0_w))
                - (geometric_anti_product_g1.xyxz() * self.group1().wwy().with_w(self[e43]))
                - (self.group0().yzxy() * geometric_anti_product_g0_xyz.zxy().with_w(geometric_anti_product_g1[1]))
                - (Simd32x2::from(geometric_anti_product_g0_w) * self.group1().xy()).with_zw(geometric_anti_product_g0_w * self[e12], geometric_anti_product_g1[0] * self[e41]),
            // e423, e431, e412, e321
            Simd32x3::from(0.0).with_w(
...
impl AntiSandwich<AntiScalar> for MultiVector {
    ...
    fn anti_sandwich(self, other: AntiScalar) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            (geometric_anti_product_g4.xyxz() * self.group0().yy().with_zw(self[e42], self[e12]))
                + (geometric_anti_product_g4.yzzw() * self.group2().zx().with_zw(self[e1234], self[e1234]))
                + (geometric_anti_product_g0.yy().with_zw(geometric_anti_product_g0[1], geometric_anti_product_g0[0] * self[e4]) * self.group4().xyz().with_w(1.0))
                ...
                + (self.group2() * geometric_anti_product_g1.www()).with_w(geometric_anti_product_g4[1] * self[e31])
    ...
    fn anti_sandwich(self, other: DualNum) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            (geometric_anti_product_g1_xyz * Simd32x3::from(self[e1234])).with_w(0.0)
                ...
                + (Simd32x3::from(geometric_anti_product_g0[1]) * self.group1().xyz()).with_w(0.0)
                + (Simd32x3::from([geometric_anti_product_g1_xyz[1], geometric_anti_product_g4[3], geometric_anti_product_g4[3]]) * anti_reverse_g2.zyz()).with_w(0.0)
                + (Simd32x3::from([geometric_anti_product_g4[3], geometric_anti_product_g1_xyz[2], geometric_anti_product_g1_xyz[0]]) * anti_reverse_g2.xxy()).with_w(0.0)
                + (Simd32x3::from([self[e3], self[e1], self[e321]]) * geometric_anti_product_g2.yzz()).with_w(0.0)
                + (Simd32x3::from([self[e4], self[e4], self[e431]]) * geometric_anti_product_g3.xyx()).with_w(0.0)
                + (Simd32x3::from([self[e412], self[e423], self[e4]]) * geometric_anti_product_g3.yzz()).with_w(0.0)
                + (Simd32x3::from([self[e321], self[e321], self[e2]]) * geometric_anti_product_g2.xyx()).with_w(0.0)
                + (anti_reverse_g3.yzx() * geometric_anti_product_g4.zxy()).with_w(0.0)
                - (anti_reverse_g3 * Simd32x3::from(geometric_anti_product_g1_w)).with_w(0.0)
                - (Simd32x3::from(self[scalar]) * geometric_anti_product_g4.xyz()).with_w(0.0)
                - (anti_reverse_g2.yzx() * geometric_anti_product_g1_xyz.zxy()).with_w(0.0)
                - (anti_reverse_g3.zxy() * geometric_anti_product_g4.yzx()).with_w(0.0)
                - (geometric_anti_product_g2.zxy() * self.group1().yzx()).with_w(0.0)
            ...
            (anti_reverse_g2 * Simd32x3::from(geometric_anti_product_g0[0]))
                ...
                - (Simd32x3::from([self[e4], self[e4], self[e431]]) * geometric_anti_product_g1_xyz.xyx())
                - (Simd32x3::from([self[e412], self[e423], self[e4]]) * geometric_anti_product_g1_xyz.yzz())
            ...
            (geometric_anti_product_g4 * Simd32x4::from(self[e1234]))
                ...
                + (Simd32x2::from(geometric_anti_product_g1_w) * anti_reverse_g2.xy())
                    .with_zw(geometric_anti_product_g1_w * anti_reverse_g2[2], geometric_anti_product_g0[0] * self[e4])
                + Simd32x3::from(0.0).with_w(
        ...
        MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                (anti_reverse_g2[1] * geometric_anti_product_g1[0])
                    ...
                    + (geometric_anti_product_g1[2] * self[e1234]),
                0.0,
            ]) + (geometric_anti_product_g0.xx().with_zw(geometric_anti_product_g0[0], geometric_anti_product_g0[1] * self[e4]) * self.group4().xyz().with_w(1.0))
                + (geometric_anti_product_g0.yy().with_zw(geometric_anti_product_g0[1], geometric_anti_product_g1[3] * self[e1234]) * self.group1().xyz().with_w(1.0))
                - (Simd32x4::from([
                    geometric_anti_product_g1[3],
                    geometric_anti_product_g4[2],
                    geometric_anti_product_g4[0],
                ...
                - (self.group0().xx().with_zw(self[scalar], geometric_anti_product_g2[2] * self[e412]) * geometric_anti_product_g4.xyz().with_w(1.0))
    ...
    fn anti_sandwich(self, other: Point) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                + (geometric_anti_product_g0.xx().with_zw(geometric_anti_product_g0[0], geometric_anti_product_g1_w * self[e1234]) * self.group4().xyz().with_w(1.0))
                - (geometric_anti_product_g4.yzxz() * anti_reverse_g3.zxy().with_w(anti_reverse_g2[2]))
                - (self.group4().yzxy() * geometric_anti_product_g3.zxy().with_w(geometric_anti_product_g2[1]))
                - (self.group0().xx().with_zw(self[scalar], geometric_anti_product_g2[2] * self[e412]) * geometric_anti_product_g4.xyz().with_w(1.0))
                - (Simd32x2::from(geometric_anti_product_g1_w) * anti_reverse_g3.xy())
                    .with_zw(geometric_anti_product_g1_w * anti_reverse_g3[2], anti_reverse_g2[0] * geometric_anti_product_g4[0])
...
impl AntiSandwich<Line> for Point {
    ...
    fn anti_sandwich(self, other: Line) -> Self::Output {
        ...
        let geometric_anti_product_g1 =
            Simd32x4::from([self[e4], self[e4], self[e4], -(other[e41] * self[e1]) - (other[e42] * self[e2]) - (other[e43] * self[e3])]) * other.group0().with_w(1.0);
        Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x3::from(self[e4] * -1.0) * geometric_anti_product_g1.xyz()).with_w(0.0),
            // e23, e31, e12, scalar
            Simd32x4::from([
                (geometric_anti_product_g0[3] * self[e1]) + (geometric_anti_product_g1[1] * self[e3]),
                (geometric_anti_product_g0[3] * self[e2]) + (geometric_anti_product_g1[2] * self[e1]),
                (geometric_anti_product_g0[3] * self[e3]) + (geometric_anti_product_g1[0] * self[e2]),
                -(geometric_anti_product_g1[2] * self[e3]) - (geometric_anti_product_g1[3] * self[e4]),
            ]) - (geometric_anti_product_g1.zxyy() * self.group0().yzxy())
...
impl AntiSandwich<Motor> for Point {
    ...
    fn anti_sandwich(self, other: Motor) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(self[e4] * -1.0) * geometric_anti_product_g1.xyz().with_w(geometric_anti_product_g0_w),
            // e23, e31, e12, scalar
            Simd32x4::from([
                (geometric_anti_product_g0_w * self[e1]) + (geometric_anti_product_g1[1] * self[e3]),
                (geometric_anti_product_g0_w * self[e2]) + (geometric_anti_product_g1[2] * self[e1]),
                (geometric_anti_product_g0_w * self[e3]) + (geometric_anti_product_g1[0] * self[e2]),
                -(geometric_anti_product_g1[2] * self[e3]) - (geometric_anti_product_g1[3] * self[e4]),
            ]) - (geometric_anti_product_g1.zxyy() * self.group0().yzxy())
                - (self.group0().wwwx()
                    * ((Simd32x3::from(other[e1234]) * self.group0().xyz()) + (other.group0().zxy() * self.group0().yzx())
                    ...
                    .with_w(geometric_anti_product_g1[0])),
        )
    }
}
    ...
    fn anti_sandwich(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            ((Simd32x3::from(self[e4])
                * Simd32x3::from([
                    other.group4().yzx()[0] * self.group0().zxy()[0],
                    other.group4().yzx()[1] * self.group0().zxy()[1],
                    other.group4().yzx()[2] * self.group0().zxy()[2],
                ]))
                ...
                - (Simd32x3::from(self[e4])
                    * Simd32x3::from([
                        other.group4().zxy()[0] * self.group0().yzx()[0],
                        other.group4().zxy()[1] * self.group0().yzx()[1],
                        other.group4().zxy()[2] * self.group0().yzx()[2],
                    ]))
            ...
            // e23, e31, e12
            (Simd32x3::from(geometric_anti_product_g1_w) * self.group0().xyz()) + (geometric_anti_product_g4.yzx() * self.group0().zxy())
                - (Simd32x3::from(self[e4])
...
impl AntiSandwich<Plane> for Point {
    ...
    fn anti_sandwich(self, other: Plane) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            ]) * geometric_anti_product_g0_xyz.with_w(1.0),
        )
    }
}
