...
impl AntiWedge<Motor> for DualNum {
    ...
    fn anti_wedge(self, other: Motor) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            Simd32x4::from(self[e1234]) * other.group0(),
            // e23, e31, e12, scalar
            (Simd32x3::from(self[e1234]) * other.group1().xyz()).with_w((self[scalar] * other[e1234]) + (self[e1234] * other[scalar])),
        )
    }
}
...
impl AntiWedge<MultiVector> for Flector {
    ...
    fn anti_wedge(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (self.group1().zxy() * other.group4().yzx()) + Simd32x2::from(0.0).with_z((self[e423] * other[e431]) * -1.0) - (self.group1().yz() * other.group4().zx()).with_z(0.0),
            // e23, e31, e12
...
impl AntiWedge<Motor> for Line {
    ...
    fn anti_wedge(self, other: Motor) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x3::from(other[e1234]) * self.group0()).with_w(0.0),
            // e23, e31, e12, scalar
...
impl AntiWedge<DualNum> for Motor {
    ...
    fn anti_wedge(self, other: DualNum) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            Simd32x4::from(other[e1234]) * self.group0(),
            // e23, e31, e12, scalar
            (Simd32x3::from(other[e1234]) * self.group1().xyz()).with_w((other[scalar] * self[e1234]) + (other[e1234] * self[scalar])),
        )
    }
}
...
impl AntiWedge<Line> for Motor {
    ...
    fn anti_wedge(self, other: Line) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x3::from(self[e1234]) * other.group0()).with_w(0.0),
            // e23, e31, e12, scalar
...
impl AntiWedge<Flector> for MultiVector {
    ...
    fn anti_wedge(self, other: Flector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (other.group1().yzx() * self.group4().zxy()) + Simd32x2::from(0.0).with_z((other[e431] * self[e423]) * -1.0) - (other.group1().zx() * self.group4().yz()).with_z(0.0),
            // e23, e31, e12
...
impl AntiWedge<Plane> for MultiVector {
    ...
    fn anti_wedge(self, other: Plane) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (self.group4().zxy() * other.group0().yzx()) + Simd32x2::from(0.0).with_z((self[e423] * other[e431]) * -1.0) - (self.group4().yz() * other.group0().zx()).with_z(0.0),
            // e23, e31, e12
...
impl AntiWedge<MultiVector> for Plane {
    ...
    fn anti_wedge(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (other.group4().yzx() * self.group0().zxy()) + Simd32x2::from(0.0).with_z((other[e431] * self[e423]) * -1.0) - (other.group4().zx() * self.group0().yz()).with_z(0.0),
            // e23, e31, e12
...
impl AntiWedge<Plane> for Plane {
    ...
    fn anti_wedge(self, other: Plane) -> Self::Output {
        ...
        Line::from_groups(
            // e41, e42, e43
            (other.group0().yzx() * self.group0().zxy()) + Simd32x2::from(0.0).with_z((other[e431] * self[e423]) * -1.0) - (other.group0().zx() * self.group0().yz()).with_z(0.0),
            // e23, e31, e12
