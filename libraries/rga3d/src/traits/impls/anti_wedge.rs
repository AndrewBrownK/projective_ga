...
impl AntiWedge<Motor> for DualNum {
    ...
    fn anti_wedge(self, other: Motor) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            Simd32x4::from(self[e1234]) * other.group0(),
            // e23, e31, e12, scalar
            (other.group1().xyz() * Simd32x2::from(self[e1234]).with_z(self[e1234])).with_w((self[scalar] * other[e1234]) + (self[e1234] * other[scalar])),
        )
    }
}
...
impl AntiWedge<Flector> for Flector {
    ...
    fn anti_wedge(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([0.0, 0.0, (other[e423] * self[e431]) - (other[e431] * self[e423]), 0.0])
...
impl AntiWedge<Motor> for Flector {
    ...
    fn anti_wedge(self, other: Motor) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([0.0, 0.0, (self[e431] * other[e23]) - (self[e423] * other[e31]), 0.0])
                + (Simd32x4::from(other[e1234]) * self.group0())
                + ((Simd32x3::from(self[e321]) * other.group0().xyz()) + ((self.group1().zx() * other.group1().yz()) - (self.group1().yz() * other.group1().zx())).with_z(0.0))
                    .with_w(0.0),
            // e423, e431, e412, e321
            Simd32x4::from(other[e1234]) * self.group1(),
        )
...
impl AntiWedge<MultiVector> for Flector {
    ...
    fn anti_wedge(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (Simd32x4::from(other[e1234]) * self.group0())
                + ((Simd32x3::from(self[e321]) * other.group2()) + (other.group3().yzx() * self.group1().zxy()) - (other.group3().zxy() * self.group1().yzx())).with_w(0.0),
            // e41, e42, e43
            Simd32x3::from([
...
impl AntiWedge<Plane> for Flector {
    ...
    fn anti_wedge(self, other: Plane) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([0.0, 0.0, (self[e431] * other[e423]) - (self[e423] * other[e431]), 0.0])
                + ((self.group1().zx() * other.group0().yz()) - (self.group1().yz() * other.group0().zx())).with_zw(0.0, 0.0),
            // e23, e31, e12, scalar
            (other.group0().wwwx() * self.group1().xyz().with_w(self[e1])) + -(Simd32x3::from(self[e321]) * other.group0().xyz()).with_w(0.0),
        )
    }
}
...
impl AntiWedge<Flector> for Line {
    ...
    fn anti_wedge(self, other: Flector) -> Self::Output {
        ...
        Point::from_groups(
            // e1, e2, e3, e4
            ((Simd32x3::from(other[e321]) * self.group0()) + (self.group1().yzx() * other.group1().zxy()) - (self.group1().zxy() * other.group1().yzx())).with_w(0.0),
        )
    }
}
...
impl AntiWedge<Motor> for Line {
    ...
    fn anti_wedge(self, other: Motor) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (self.group0() * Simd32x4::from(other[e1234]).xyz()).with_w(0.0),
            // e23, e31, e12, scalar
            (self.group1() * Simd32x4::from(other[e1234]).xyz()).with_w(
...
impl AntiWedge<MultiVector> for Line {
    ...
    fn anti_wedge(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            ((Simd32x3::from(other[e321]) * self.group0()) + (self.group1().yzx() * other.group4().zxy()) - (self.group1().zxy() * other.group4().yzx())).with_w(0.0),
            // e41, e42, e43
            Simd32x3::from(other[e1234]) * self.group0(),
            // e23, e31, e12
            Simd32x3::from(other[e1234]) * self.group1(),
...
impl AntiWedge<DualNum> for Motor {
    ...
    fn anti_wedge(self, other: DualNum) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            Simd32x4::from(other[e1234]) * self.group0(),
            // e23, e31, e12, scalar
            (self.group1().xyz() * Simd32x2::from(other[e1234]).with_z(other[e1234])).with_w((other[scalar] * self[e1234]) + (other[e1234] * self[scalar])),
        )
    }
}
impl AntiWedge<Flector> for Motor {
    ...
    fn anti_wedge(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([0.0, 0.0, (other[e431] * self[e23]) - (other[e423] * self[e31]), 0.0])
                + (Simd32x4::from(self[e1234]) * other.group0())
                + ((Simd32x3::from(other[e321]) * self.group0().xyz()) + ((other.group1().zx() * self.group1().yz()) - (other.group1().yz() * self.group1().zx())).with_z(0.0))
                    .with_w(0.0),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * other.group1(),
        )
...
impl AntiWedge<Line> for Motor {
    ...
    fn anti_wedge(self, other: Line) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (other.group0() * Simd32x4::from(self[e1234]).xyz()).with_w(0.0),
            // e23, e31, e12, scalar
            (other.group1() * Simd32x4::from(self[e1234]).xyz()).with_w(
                -(other[e41] * self[e23]) - (other[e42] * self[e31]) - (other[e43] * self[e12]) - (other[e23] * self[e41]) - (other[e31] * self[e42]) - (other[e12] * self[e43]),
            ),
        )
    }
    ...
    fn anti_wedge(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x4::from([0.0, 0.0, (self[e23] * other[e431]) - (self[e31] * other[e423]), 0.0])
                ...
                + ((Simd32x3::from(self[e1234]) * other.group1().xyz()) + ((self.group1().yz() * other.group4().zx()) - (self.group1().zx() * other.group4().yz())).with_z(0.0))
                    .with_w(0.0),
            // e41, e42, e43
            (Simd32x3::from(other[e1234]) * self.group0().xyz()) + (Simd32x3::from(self[e1234]) * other.group2()),
            // e23, e31, e12
            (Simd32x3::from(other[e1234]) * self.group1().xyz()) + (Simd32x3::from(self[e1234]) * other.group3()),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * other.group4(),
        )
    }
...
impl AntiWedge<Plane> for Motor {
    ...
    fn anti_wedge(self, other: Plane) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([0.0, 0.0, (self[e23] * other[e431]) - (self[e31] * other[e423]), 0.0])
                + ((Simd32x3::from(other[e321]) * self.group0().xyz()) + ((self.group1().yz() * other.group0().zx()) - (self.group1().zx() * other.group0().yz())).with_z(0.0))
                    .with_w(0.0),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * other.group0(),
        )
...
impl AntiWedge<Flector> for MultiVector {
    ...
    fn anti_wedge(self, other: Flector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (Simd32x4::from(self[e1234]) * other.group0())
                + ((Simd32x3::from(other[e321]) * self.group2()) + (self.group3().yzx() * other.group1().zxy()) - (self.group3().zxy() * other.group1().yzx())).with_w(0.0),
            // e41, e42, e43
            Simd32x3::from([
    ...
    fn anti_wedge(self, other: Motor) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x4::from([0.0, 0.0, (other[e23] * self[e431]) - (other[e31] * self[e423]), 0.0])
                ...
                + ((Simd32x3::from(other[e1234]) * self.group1().xyz()) + ((other.group1().yz() * self.group4().zx()) - (other.group1().zx() * self.group4().yz())).with_z(0.0))
                    .with_w(0.0),
            // e41, e42, e43
            (Simd32x3::from(self[e1234]) * other.group0().xyz()) + (Simd32x3::from(other[e1234]) * self.group2()),
            // e23, e31, e12
            (Simd32x3::from(self[e1234]) * other.group1().xyz()) + (Simd32x3::from(other[e1234]) * self.group3()),
            // e423, e431, e412, e321
            Simd32x4::from(other[e1234]) * self.group4(),
        )
    }
    ...
    fn anti_wedge(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x3::from([
                ...
                + (Simd32x3::from(self[e1234]) * other.group2()),
            // e23, e31, e12
            (Simd32x3::from(other[e1234]) * self.group3()) + (Simd32x3::from(self[e1234]) * other.group3()) + (Simd32x3::from(other[e321]) * self.group4().xyz())
...
impl AntiWedge<Plane> for MultiVector {
    ...
    fn anti_wedge(self, other: Plane) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            ((Simd32x3::from(other[e321]) * self.group2()) + (self.group3().yzx() * other.group0().zxy()) - (self.group3().zxy() * other.group0().yzx())).with_w(0.0),
            // e41, e42, e43
            Simd32x3::from([
                (self[e412] * other[e431]) - (self[e431] * other[e412]),
                (self[e423] * other[e412]) - (self[e412] * other[e423]),
...
impl AntiWedge<Flector> for Plane {
    ...
    fn anti_wedge(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            (Simd32x3::from(other[e321]) * self.group0().xyz()).with_w(0.0) - (Simd32x4::from(self[e321]) * other.group1().xyz().with_w(other[e4])),
        )
    }
}
...
impl AntiWedge<MultiVector> for Plane {
    ...
    fn anti_wedge(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            ((Simd32x3::from(self[e321]) * other.group2()) + (other.group3().yzx() * self.group0().zxy()) - (other.group3().zxy() * self.group0().yzx())).with_w(0.0),
            // e41, e42, e43
            Simd32x3::from([
                (other[e431] * self[e412]) - (other[e412] * self[e431]),
                (other[e412] * self[e423]) - (other[e423] * self[e412]),
