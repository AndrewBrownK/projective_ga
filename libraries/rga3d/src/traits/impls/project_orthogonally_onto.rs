    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            (wedge_g1 * Simd32x4::from(other[e1234]))
                ...
                + Simd32x3::from(0.0)
                    .with_w(-(wedge_g2[0] * other[e423]) - (wedge_g2[1] * other[e431]) - (wedge_g2[2] * other[e412]) - (wedge_g4[1] * other[e42]) - (wedge_g4[2] * other[e43]))
...
impl ProjectOrthogonallyOnto<MultiVector> for Flector {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge_g2 = Simd32x3::from([right_anti_dual_g1_w * self[e1] * -1.0, right_anti_dual_g1_w * self[e2] * -1.0, right_anti_dual_g1_w * self[e3] * -1.0]);
...
impl ProjectOrthogonallyOnto<MultiVector> for Line {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (Simd32x4::from(wedge_g0_y) * other.group1())
                + Simd32x3::from(0.0).with_w(-(wedge_g4[1] * other[e42]) - (wedge_g4[2] * other[e43]))
                + (Simd32x3::from(wedge_g4[3]) * other.group2()).with_w(0.0)
                + (other.group3().yzx() * wedge_g4.zxy()).with_w(0.0)
                - (wedge_g4.yzxx() * other.group3().zxy().with_w(other[e41])),
            // e41, e42, e43
...
impl ProjectOrthogonallyOnto<MultiVector> for Motor {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge_g1 = Simd32x3::from(0.0).with_w(right_anti_dual_g1_w * self[scalar]);
    ...
    fn project_orthogonally_onto(self, other: Plane) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            Simd32x4::from([
                ...
                wedge_g1_xyz[1] * other[e321] * -1.0,
                wedge_g1_xyz[2] * other[e321] * -1.0,
                right_anti_dual_g0 * self[scalar] * other[e321] * -1.0,
            ]),
        )
    }
}
...
impl ProjectOrthogonallyOnto<Flector> for MultiVector {
    ...
    fn project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let wedge_g0_y =
            (right_anti_dual_g1_xyz[0] * self[e1]) + (right_anti_dual_g1_xyz[1] * self[e2]) + (right_anti_dual_g1_xyz[2] * self[e3]) - (right_anti_dual_g0_w * self[e321]);
        let wedge_g2 = Simd32x3::from(right_anti_dual_g0_w * -1.0) * self.group1().xyz();
...
impl ProjectOrthogonallyOnto<Motor> for MultiVector {
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        use crate::elements::*;
        let wedge_g0_y = (other[e23] * self[e23]) + (other[e31] * self[e31]) + (other[e12] * self[e12]) + (other[scalar] * self[scalar]);
