    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            Simd32x3::from(0.0).with_w(-(right_anti_dual_g1_xyz[1] * wedge_g0[1]) - (right_anti_dual_g1_xyz[2] * wedge_g0[2]) - (wedge_g0[3] * other[e321]))
                + (right_anti_dual_g1_xyz.zxy() * wedge_g1_xyz.yzx()).with_w(0.0)
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            Simd32x3::from(0.0).with_w(-(right_anti_dual_g0_xyz[1] * wedge_g0[1]) - (right_anti_dual_g0_xyz[2] * wedge_g0[2]))
                + (right_anti_dual_g0_xyz.zxy() * wedge_g1_xyz.yzx()).with_w(0.0)
...
impl AntiRejectOrthogonallyFrom<Horizon> for MultiVector {
    ...
    fn anti_reject_orthogonally_from(self, other: Horizon) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([right_anti_dual_g0 * other[e321] * self[scalar] * -1.0, 0.0]),
            // e1, e2, e3, e4
