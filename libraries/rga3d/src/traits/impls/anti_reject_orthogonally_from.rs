    ...
    fn anti_reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                -(right_anti_dual_g2[1] * wedge_g4[1]) - (right_anti_dual_g2[2] * wedge_g4[2]) - (wedge_g2[0] * other[e1]) - (wedge_g2[1] * other[e2]) - (wedge_g2[2] * other[e3]),
            ]) + (right_anti_dual_g1 * Simd32x4::from(wedge_g0_y))
                + (right_anti_dual_g2 * wedge_g4.www()).with_w(wedge_g1[3] * other[scalar])
                - (wedge_g3.zxy() * other.group1().yzx()).with_w(right_anti_dual_g2[0] * wedge_g4[0]),
            // e41, e42, e43
...
impl AntiRejectOrthogonallyFrom<Motor> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: Motor) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            ]) + (right_anti_dual_g0 * wedge_g1.www().with_w(wedge_g0[3])),
            // e423, e431, e412, e321
...
impl AntiRejectOrthogonallyFrom<MultiVector> for Horizon {
    ...
    fn anti_reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([right_anti_dual_g1_w * wedge_g4_w, wedge_g0_y * other[scalar]]) * Simd32x2::from(-1.0),
            // e1, e2, e3, e4
            (Simd32x2::from(wedge_g4_w) * right_anti_dual_g2.xy()).with_zw(wedge_g4_w * right_anti_dual_g2[2], right_anti_dual_g1_w * wedge_g0_y * -1.0),
            // e41, e42, e43
            right_anti_dual_g2 * Simd32x3::from(wedge_g0_y * -1.0),
            // e23, e31, e12
...
impl AntiRejectOrthogonallyFrom<MultiVector> for Origin {
    ...
    fn anti_reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (right_anti_dual_g2 * Simd32x3::from(wedge_g0_y)) + (wedge_g2 * Simd32x3::from(other[scalar])) + (wedge_g4_xyz.zxy() * other.group1().yzx())
