...
impl AntiRejectOrthogonallyFrom<Flector> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_anti_dual_g1_xyz[0] * wedge_g1[3] * -1.0,
                right_anti_dual_g1_xyz[1] * wedge_g1[3] * -1.0,
                right_anti_dual_g1_xyz[2] * wedge_g1[3] * -1.0,
        ...
        MultiVector::from_groups(
            ...
            (right_anti_dual_g1 * Simd32x4::from(wedge_g0_y))
                ...
                + Simd32x3::from(0.0).with_w(
                    -(right_anti_dual_g2[0] * wedge_g4[0])
                ...
                + (right_anti_dual_g2 * Simd32x3::from(wedge_g4[3])).with_w(0.0)
                + (wedge_g2 * Simd32x3::from(right_anti_dual_g4[3])).with_w(0.0)
                + (wedge_g3.yzx() * right_anti_dual_g4.zxy()).with_w(0.0)
                - (right_anti_dual_g4.yzxx() * wedge_g3.zxy().with_w(wedge_g2[0])),
            // e41, e42, e43
            (right_anti_dual_g2 * Simd32x3::from(wedge_g0_y))
                + (wedge_g2 * Simd32x3::from(other[scalar]))
                + Simd32x2::from(0.0).with_z((right_anti_dual_g4[0] * wedge_g4[1]) - (right_anti_dual_g4[1] * wedge_g4[0]))
                + (right_anti_dual_g4.yz() * wedge_g4.zx()).with_z(0.0)
                - (right_anti_dual_g4.zx() * wedge_g4.yz()).with_z(0.0),
            // e23, e31, e12
...
impl AntiRejectOrthogonallyFrom<Flector> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(-(right_anti_dual_g1_xyz[1] * wedge_g0[1]) - (right_anti_dual_g1_xyz[2] * wedge_g0[2]) - (wedge_g0[3] * other[e321]))
                + (right_anti_dual_g1_xyz.zxy() * wedge_g1.yzx()).with_w(0.0)
                - (right_anti_dual_g1_xyz.yzx() * wedge_g1.zxy()).with_w(right_anti_dual_g1_xyz[0] * wedge_g0[0]),
            // e423, e431, e412, e321
...
impl AntiRejectOrthogonallyFrom<Point> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(-(right_anti_dual_g0_xyz[1] * wedge_g0[1]) - (right_anti_dual_g0_xyz[2] * wedge_g0[2]))
                + (right_anti_dual_g0_xyz.zxy() * wedge_g1.yzx()).with_w(0.0)
...
impl AntiRejectOrthogonallyFrom<MultiVector> for Horizon {
    ...
    fn anti_reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (right_anti_dual_g1 * Simd32x4::from(wedge_g0_y))
                + Simd32x3::from(0.0).with_w(-(right_anti_dual_g2[0] * wedge_g4[0]) - (right_anti_dual_g2[1] * wedge_g4[1]) - (right_anti_dual_g2[2] * wedge_g4[2]))
                + (right_anti_dual_g2 * Simd32x3::from(wedge_g4[3])).with_w(0.0),
            // e41, e42, e43
            (right_anti_dual_g2 * Simd32x3::from(wedge_g0_y))
                + Simd32x2::from(0.0).with_z((right_anti_dual_g4[0] * wedge_g4[1]) - (right_anti_dual_g4[1] * wedge_g4[0]))
...
impl AntiRejectOrthogonallyFrom<Flector> for Line {
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_anti_dual_g1_xyz[0] * wedge_g0[3] * -1.0,
                right_anti_dual_g1_xyz[1] * wedge_g0[3] * -1.0,
                right_anti_dual_g1_xyz[2] * wedge_g0[3] * -1.0,
...
impl AntiRejectOrthogonallyFrom<Point> for Line {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        Line::from_groups(
            ...
            // e23, e31, e12
            Simd32x3::from([
                right_anti_dual_g0_xyz[0] * wedge_g0[3] * -1.0,
                right_anti_dual_g0_xyz[1] * wedge_g0[3] * -1.0,
                right_anti_dual_g0_xyz[2] * wedge_g0[3] * -1.0,
            ]),
        )
    }
}
...
impl AntiRejectOrthogonallyFrom<Point> for Motor {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_anti_dual_g0_xyz[0] * wedge_g1[3] * -1.0,
                right_anti_dual_g0_xyz[1] * wedge_g1[3] * -1.0,
                right_anti_dual_g0_xyz[2] * wedge_g1[3] * -1.0,
                (right_anti_dual_g0_xyz[0] * wedge_g0[0]) + (right_anti_dual_g0_xyz[1] * wedge_g0[1]) + (right_anti_dual_g0_xyz[2] * wedge_g0[2]),
            ]),
        )
    }
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            (right_anti_dual_g0 * Simd32x4::from(wedge_g0_y))
                + Simd32x3::from(0.0).with_w(-(right_anti_dual_g1_xyz[1] * wedge_g2[1]) - (right_anti_dual_g1_xyz[2] * wedge_g2[2]))
                + (right_anti_dual_g1_xyz.zxy() * wedge_g3.yzx()).with_w(0.0)
            ...
            // e23, e31, e12
            Simd32x3::from([
                right_anti_dual_g1_xyz[0] * wedge_g4[3] * -1.0,
                right_anti_dual_g1_xyz[1] * wedge_g4[3] * -1.0,
                right_anti_dual_g1_xyz[2] * wedge_g4[3] * -1.0,
            ]),
            // e423, e431, e412, e321
...
impl AntiRejectOrthogonallyFrom<Motor> for MultiVector {
    ...
    fn anti_reject_orthogonally_from(self, other: Motor) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (self[scalar] * right_anti_dual_g0[3] * other[scalar])
            ...
            // e1, e2, e3, e4
            (right_anti_dual_g0 * Simd32x3::from(wedge_g4[3]).with_w(wedge_g1[3]))
                + Simd32x3::from(0.0).with_w(-(right_anti_dual_g0[0] * wedge_g4[0]) - (right_anti_dual_g0[1] * wedge_g4[1]) - (right_anti_dual_g0[2] * wedge_g4[2]))
                + (Simd32x3::from(right_anti_dual_g0[3]) * wedge_g1.xyz()).with_w(0.0),
            // e41, e42, e43
            (Simd32x3::from(wedge_g0_y) * right_anti_dual_g0.xyz())
                + (Simd32x3::from(self[scalar] * right_anti_dual_g0[3]) * other.group0().xyz())
...
impl AntiRejectOrthogonallyFrom<Point> for MultiVector {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(-(right_anti_dual_g0_xyz[1] * wedge_g2[1]) - (right_anti_dual_g0_xyz[2] * wedge_g2[2]))
                + (right_anti_dual_g0_xyz.zxy() * wedge_g3.yzx()).with_w(0.0)
            ...
            // e23, e31, e12
            Simd32x3::from([
                right_anti_dual_g0_xyz[0] * wedge_g4[3] * -1.0,
                right_anti_dual_g0_xyz[1] * wedge_g4[3] * -1.0,
                right_anti_dual_g0_xyz[2] * wedge_g4[3] * -1.0,
            ]),
            // e423, e431, e412, e321
