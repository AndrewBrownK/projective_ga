...
impl RejectOrthogonallyFrom<Flector> for AntiScalar {
    ...
    fn reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([
                right_anti_dual_g0_w * anti_wedge_g0[0] * -1.0,
                right_anti_dual_g0_w * anti_wedge_g0[1] * -1.0,
                right_anti_dual_g0_w * anti_wedge_g0[2] * -1.0,
                (right_anti_dual_g1_xyz[0] * anti_wedge_g0[0]) + (right_anti_dual_g1_xyz[1] * anti_wedge_g0[1]) + (right_anti_dual_g1_xyz[2] * anti_wedge_g0[2])
                    - (right_anti_dual_g0_w * other[e321] * self[e1234]),
            ]),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        )
    ...
    fn reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            (anti_wedge_g3 * Simd32x3::from(right_anti_dual_g1_w)).with_w(0.0)
                + (right_anti_dual_g4_xyz * Simd32x3::from(anti_wedge_g0[0])).with_w(0.0)
...
impl RejectOrthogonallyFrom<MultiVector> for DualNum {
    ...
    fn reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            (anti_wedge_g3 * Simd32x3::from(right_anti_dual_g1_w)).with_w(0.0)
                + (right_anti_dual_g4_xyz * Simd32x3::from(anti_wedge_g0_x)).with_w(0.0)
                + (right_anti_dual_g2.yzx() * anti_wedge_g1.zxy()).with_w(0.0)
                - (right_anti_dual_g2.zxy() * anti_wedge_g1.yzx()).with_w(0.0),
        )
    }
...
impl RejectOrthogonallyFrom<Plane> for Horizon {
    ...
    fn reject_orthogonally_from(self, other: Plane) -> Self::Output {
        use crate::elements::*;
        Plane::from_groups(/* e423, e431, e412, e321 */ (Simd32x3::from(other[e321] * self[e321]) * other.group0().xyz()).with_w(0.0))
    }
}
...
impl RejectOrthogonallyFrom<Flector> for Line {
    ...
    fn reject_orthogonally_from(self, other: Flector) -> Self::Output {
        use crate::elements::*;
        let anti_wedge_g0 = Simd32x3::from(0.0).with_w(-(self[e42] * other[e431]) - (self[e43] * other[e412]))
...
impl RejectOrthogonallyFrom<Horizon> for Motor {
    ...
    fn reject_orthogonally_from(self, other: Horizon) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(other[e321]) * (Simd32x3::from(other[e321]) * self.group0().xyz()).with_w(self[e1234] * other[e321]),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        )
    }
...
impl RejectOrthogonallyFrom<Flector> for MultiVector {
    ...
    fn reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x2::from([
                0.0,
                (right_anti_dual_g1_xyz[0] * anti_wedge_g1[0]) + (right_anti_dual_g1_xyz[1] * anti_wedge_g1[1]) + (right_anti_dual_g1_xyz[2] * anti_wedge_g1[2])
                    - (right_anti_dual_g0_w * self[e1234] * other[e321]),
            ]),
            // e1, e2, e3, e4
            ...
            // e41, e42, e43
            Simd32x3::from([
                right_anti_dual_g0_w * anti_wedge_g1[0] * -1.0,
                right_anti_dual_g0_w * anti_wedge_g1[1] * -1.0,
                right_anti_dual_g0_w * anti_wedge_g1[2] * -1.0,
            ]),
            // e23, e31, e12
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            (right_anti_dual_g1_xyz * Simd32x3::from(anti_wedge_g0_x)).with_w(0.0) + (Simd32x3::from(right_anti_dual_g0_w * other[e321]) * self.group4().xyz()).with_w(0.0)
...
impl RejectOrthogonallyFrom<MultiVector> for MultiVector {
    ...
    fn reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge_g1 = (Simd32x4::from(other[e1234]) * self.group1())
            + (Simd32x4::from(self[e1234]) * other.group1())
            + Simd32x3::from(0.0).with_w(-(other[e42] * self[e431]) - (other[e43] * self[e412]) - (self[e42] * other[e431]) - (self[e43] * other[e412]))
            + (Simd32x3::from(other[e321]) * self.group2()).with_w(0.0)
            + (Simd32x3::from(self[e321]) * other.group2()).with_w(0.0)
...
impl RejectOrthogonallyFrom<MultiVector> for Point {
    ...
    fn reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            (right_anti_dual_g4_xyz * Simd32x3::from(anti_wedge_g0_x)).with_w(0.0) + (right_anti_dual_g2.yzx() * anti_wedge_g1.zxy()).with_w(0.0)
                - (right_anti_dual_g2.zxy() * anti_wedge_g1.yzx()).with_w(0.0),
        )
    }
}
