...
impl RejectOrthogonallyFrom<Flector> for AntiScalar {
    ...
    fn reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x3::from(right_anti_dual_g0_w * -1.0) * anti_wedge_g0.xyz()).with_w((anti_wedge_g0[0] * other[e1]) - (right_anti_dual_g0_w * other[e321] * self[e1234])),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        )
    }
        ...
        MultiVector::from_groups(
            ...
            Simd32x2::from([
                ...
                (anti_wedge_g0[0] * other[scalar])
                    + (right_anti_dual_g4_xyz[0] * anti_wedge_g1[0])
                    + (right_anti_dual_g4_xyz[1] * anti_wedge_g1[1])
                    + (right_anti_dual_g4_xyz[2] * anti_wedge_g1[2])
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            ((anti_wedge_g3 * Simd32x3::from(right_anti_dual_g1_w))
                + (right_anti_dual_g4_xyz * Simd32x3::from(anti_wedge_g0[0]))
                + (right_anti_dual_g2.yzx() * anti_wedge_g1.zxy())
                - (right_anti_dual_g2.zxy() * anti_wedge_g1.yzx()))
            .with_w(0.0),
        )
    }
}
...
impl RejectOrthogonallyFrom<Point> for AntiScalar {
    ...
    fn reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        AntiScalar::from_groups(
            // e1234
            (right_anti_dual_g0_xyz[0] * anti_wedge_g0[0]) + (right_anti_dual_g0_xyz[1] * anti_wedge_g0[1]) + (right_anti_dual_g0_xyz[2] * anti_wedge_g0[2]),
        )
    }
}
...
impl RejectOrthogonallyFrom<Flector> for DualNum {
    ...
    fn reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x3::from(right_anti_dual_g0_w * -1.0) * anti_wedge_g0.xyz()).with_w((anti_wedge_g0[0] * other[e1]) - (right_anti_dual_g0_w * self[e1234] * other[e321])),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        )
    }
...
impl RejectOrthogonallyFrom<MultiVector> for DualNum {
    ...
    fn reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            ((anti_wedge_g3 * Simd32x3::from(right_anti_dual_g1_w))
                + (right_anti_dual_g4_xyz * Simd32x3::from(anti_wedge_g0_x))
                + (right_anti_dual_g2.yzx() * anti_wedge_g1.zxy())
                - (right_anti_dual_g2.zxy() * anti_wedge_g1.yzx()))
            .with_w(0.0),
        )
    ...
    fn reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x2::from([
                0.0,
                (anti_wedge_g0_x * other[scalar])
                    + (anti_wedge_g1_xyz[0] * right_anti_dual_g4_xyz[0])
                    + (anti_wedge_g1_xyz[1] * right_anti_dual_g4_xyz[1])
                    + (anti_wedge_g1_xyz[2] * right_anti_dual_g4_xyz[2])
                    - (anti_wedge_g3[0] * right_anti_dual_g2[0])
                    - (anti_wedge_g3[1] * right_anti_dual_g2[1])
                    - (anti_wedge_g3[2] * right_anti_dual_g2[2])
            ...
            Simd32x3::from(0.0).with_w(anti_wedge_g0_x * right_anti_dual_g1_w),
            // e41, e42, e43
            (right_anti_dual_g2 * Simd32x3::from(anti_wedge_g0_x)) - (anti_wedge_g1_xyz * Simd32x3::from(right_anti_dual_g1_w)),
            // e23, e31, e12
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            ((anti_wedge_g3 * Simd32x3::from(right_anti_dual_g1_w))
                + (right_anti_dual_g4_xyz * Simd32x3::from(anti_wedge_g0_x))
                + (anti_wedge_g1_xyz.zxy() * right_anti_dual_g2.yzx())
                - (anti_wedge_g1_xyz.yzx() * right_anti_dual_g2.zxy()))
            .with_w(0.0),
        )
    }
}
impl RejectOrthogonallyFrom<Plane> for Flector {
    ...
    fn reject_orthogonally_from(self, other: Plane) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(right_anti_dual_g0 * self[e1] * other[e423]),
            // e423, e431, e412, e321
            ((Simd32x3::from(right_anti_dual_g0 * other[e321]) * self.group1().xyz()) - (Simd32x3::from(right_anti_dual_g0 * self[e321]) * other.group0().xyz())).with_w(0.0),
        )
    }
}
...
impl RejectOrthogonallyFrom<Flector> for Motor {
    ...
    fn reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (anti_wedge_g0_xyz * Simd32x3::from(right_anti_dual_g0_w * -1.0)).with_w((anti_wedge_g0_xyz[0] * other[e1]) - (right_anti_dual_g0_w * other[e321] * self[e1234])),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        )
    }
...
impl RejectOrthogonallyFrom<Flector> for MultiVector {
    ...
    fn reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x2::from([
                0.0,
                (anti_wedge_g1_xyz[0] * right_anti_dual_g1_xyz[0]) + (anti_wedge_g1_xyz[1] * right_anti_dual_g1_xyz[1]) + (anti_wedge_g1_xyz[2] * right_anti_dual_g1_xyz[2])
                    - (right_anti_dual_g0_w * self[e1234] * other[e321]),
            ]),
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(anti_wedge_g0_x * right_anti_dual_g0_w),
            // e41, e42, e43
            anti_wedge_g1_xyz * Simd32x3::from(right_anti_dual_g0_w * -1.0),
            // e23, e31, e12
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            ((right_anti_dual_g1_xyz * Simd32x3::from(anti_wedge_g0_x)) + (Simd32x3::from(right_anti_dual_g0_w * other[e321]) * self.group4().xyz())
                - (Simd32x3::from(right_anti_dual_g0_w * self[e321]) * other.group1().xyz()))
            .with_w(0.0),
        )
    }
}
...
impl RejectOrthogonallyFrom<Plane> for MultiVector {
    ...
    fn reject_orthogonally_from(self, other: Plane) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (Simd32x3::from(right_anti_dual_g0) * Simd32x3::from([self[e12] * other[e431], self[e23] * other[e412], self[e31] * other[e423]]))
                - (Simd32x3::from(right_anti_dual_g0) * Simd32x3::from([self[e31] * other[e412], self[e12] * other[e423], self[e23] * other[e431]]))
...
impl RejectOrthogonallyFrom<Point> for MultiVector {
    ...
    fn reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x2::from([
                0.0,
                (right_anti_dual_g0_xyz[0] * anti_wedge_g1[0]) + (right_anti_dual_g0_xyz[1] * anti_wedge_g1[1]) + (right_anti_dual_g0_xyz[2] * anti_wedge_g1[2]),
            ]),
            // e1, e2, e3, e4
            Simd32x4::from(0.0),
            // e41, e42, e43
...
impl RejectOrthogonallyFrom<Flector> for Plane {
    ...
    fn reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(anti_wedge_g1_w * right_anti_dual_g0_w),
            // e423, e431, e412, e321
            ((Simd32x3::from(anti_wedge_g1_w) * other.group0().xyz()) + (Simd32x3::from(right_anti_dual_g0_w * other[e321]) * self.group0().xyz())
                - (Simd32x3::from(right_anti_dual_g0_w * self[e321]) * other.group1().xyz()))
            .with_w(0.0),
        )
    }
...
impl RejectOrthogonallyFrom<MultiVector> for Point {
    ...
    fn reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            ((right_anti_dual_g4_xyz * Simd32x3::from(anti_wedge_g0_x)) + (right_anti_dual_g2.yzx() * anti_wedge_g1.zxy()) - (right_anti_dual_g2.zxy() * anti_wedge_g1.yzx()))
                .with_w(0.0),
        )
    }
}
