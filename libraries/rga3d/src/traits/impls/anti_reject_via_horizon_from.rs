...
impl AntiRejectViaHorizonFrom<Flector> for DualNum {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            (right_dual_g1_xyz * Simd32x3::from(wedge_g1[3] * -1.0))
                .with_w((right_dual_g1_xyz[0] * wedge_g0[0]) + (right_dual_g1_xyz[1] * wedge_g0[1]) + (right_dual_g1_xyz[2] * wedge_g0[2]) + (wedge_g1[3] * other[e321])),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<MultiVector> for DualNum {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            Simd32x4::from([
                (wedge_g2[0] * right_dual_g4[3]) + (wedge_g3[1] * right_dual_g4[2]) + (wedge_g1[0] * other[scalar]),
                (wedge_g2[1] * right_dual_g4[3]) + (wedge_g3[2] * right_dual_g4[0]) + (wedge_g1[1] * other[scalar]),
                (wedge_g2[2] * right_dual_g4[3]) + (wedge_g3[0] * right_dual_g4[1]) + (wedge_g1[2] * other[scalar]),
                -(right_dual_g2[1] * wedge_g4[1])
                    - (right_dual_g2[2] * wedge_g4[2])
                    - (wedge_g2[0] * right_dual_g4[0])
                    - (wedge_g2[1] * right_dual_g4[1])
                    - (wedge_g2[2] * right_dual_g4[2]),
            ]) + (right_dual_g1 * Simd32x4::from(wedge_g0_y))
                + (right_dual_g2 * Simd32x3::from(wedge_g4[3])).with_w(wedge_g1[3] * other[scalar])
                - (wedge_g3.zxy() * right_dual_g4.yzx()).with_w(right_dual_g2[0] * wedge_g4[0]),
            // e41, e42, e43
            (right_dual_g2 * Simd32x3::from(wedge_g0_y)) + (wedge_g2 * Simd32x3::from(other[scalar])) + (right_dual_g4.yzx() * wedge_g4.zxy())
                - (right_dual_g4.zxy() * wedge_g4.yzx()),
            // e23, e31, e12
...
impl AntiRejectViaHorizonFrom<Flector> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                right_dual_g1_xyz[2] * wedge_g1_xyz[1],
                right_dual_g1_xyz[0] * wedge_g1_xyz[2],
                right_dual_g1_xyz[1] * wedge_g1_xyz[0],
                -(right_dual_g1_xyz[1] * wedge_g0[1]) - (right_dual_g1_xyz[2] * wedge_g0[2]) - (wedge_g0[3] * other[e321]),
...
impl AntiRejectViaHorizonFrom<Motor> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Motor) -> Self::Output {
        ...
        Flector::from_groups(
            ...
            ]) + (right_dual_g0 * Simd32x4::from([wedge_g1[3], wedge_g1[3], wedge_g1[3], wedge_g0[3]])),
            // e423, e431, e412, e321
...
impl AntiRejectViaHorizonFrom<Point> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                right_dual_g0_xyz[2] * wedge_g1_xyz[1],
                right_dual_g0_xyz[0] * wedge_g1_xyz[2],
                right_dual_g0_xyz[1] * wedge_g1_xyz[0],
                -(right_dual_g0_xyz[1] * wedge_g0[1]) - (right_dual_g0_xyz[2] * wedge_g0[2]),
...
impl AntiRejectViaHorizonFrom<MultiVector> for Horizon {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (right_dual_g4.yzx() * wedge_g4.zxy()) - (right_dual_g2 * Simd32x3::from(wedge_g0_y)) - (right_dual_g4.zxy() * wedge_g4.yzx()),
            // e23, e31, e12
            (Simd32x3::from(right_dual_g4[3]) * wedge_g4.xyz()) - (Simd32x3::from(wedge_g4[3]) * right_dual_g4.xyz()),
            // e423, e431, e412, e321
            (wedge_g4 * Simd32x4::from(other[scalar])) - (right_dual_g4 * Simd32x4::from(wedge_g0_y)),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Flector> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_dual_g1_xyz[0] * wedge_g0[3],
                right_dual_g1_xyz[1] * wedge_g0[3],
                right_dual_g1_xyz[2] * wedge_g0[3],
...
impl AntiRejectViaHorizonFrom<MultiVector> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_dual_g2[0] * wedge_g4[3]) + (wedge_g2[0] * right_dual_g4[3]) + (wedge_g3[1] * right_dual_g4[2]),
                (right_dual_g2[1] * wedge_g4[3]) + (wedge_g2[1] * right_dual_g4[3]) + (wedge_g3[2] * right_dual_g4[0]),
                (right_dual_g2[2] * wedge_g4[3]) + (wedge_g2[2] * right_dual_g4[3]) + (wedge_g3[0] * right_dual_g4[1]),
                -(right_dual_g2[1] * wedge_g4[1])
                    - (right_dual_g2[2] * wedge_g4[2])
                    - (wedge_g2[0] * right_dual_g4[0])
                    - (wedge_g2[1] * right_dual_g4[1])
...
impl AntiRejectViaHorizonFrom<Point> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Line::from_groups(
            ...
            // e23, e31, e12
            Simd32x3::from([right_dual_g0_xyz[0] * wedge_g0[3], right_dual_g0_xyz[1] * wedge_g0[3], right_dual_g0_xyz[2] * wedge_g0[3]]) * Simd32x3::from(-1.0),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Point> for Motor {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_dual_g0_xyz[0] * wedge_g1[3],
                right_dual_g0_xyz[1] * wedge_g1[3],
                right_dual_g0_xyz[2] * wedge_g1[3],
                (right_dual_g0_xyz[0] * wedge_g0[0]) + (right_dual_g0_xyz[1] * wedge_g0[1]) + (right_dual_g0_xyz[2] * wedge_g0[2]),
            ]) * Simd32x4::from([-1.0, -1.0, -1.0, 1.0]),
        )
    }
...
impl AntiRejectViaHorizonFrom<Flector> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            Simd32x4::from([
                right_dual_g1_xyz[2] * wedge_g3[1],
                right_dual_g1_xyz[0] * wedge_g3[2],
                right_dual_g1_xyz[1] * wedge_g3[0],
                -(right_dual_g1_xyz[1] * wedge_g2[1]) - (right_dual_g1_xyz[2] * wedge_g2[2]),
            ...
            // e23, e31, e12
            Simd32x3::from([right_dual_g1_xyz[0] * wedge_g4[3], right_dual_g1_xyz[1] * wedge_g4[3], right_dual_g1_xyz[2] * wedge_g4[3]]) * Simd32x3::from(-1.0),
            // e423, e431, e412, e321
...
impl AntiRejectViaHorizonFrom<Motor> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Motor) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            ]) + (right_dual_g0 * Simd32x4::from([wedge_g4[3], wedge_g4[3], wedge_g4[3], wedge_g1[3]])),
            // e41, e42, e43
...
impl AntiRejectViaHorizonFrom<Point> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            Simd32x4::from([
                right_dual_g0_xyz[2] * wedge_g3[1],
                right_dual_g0_xyz[0] * wedge_g3[2],
                right_dual_g0_xyz[1] * wedge_g3[0],
                -(right_dual_g0_xyz[1] * wedge_g2[1]) - (right_dual_g0_xyz[2] * wedge_g2[2]),
            ...
            // e23, e31, e12
            Simd32x3::from([right_dual_g0_xyz[0] * wedge_g4[3], right_dual_g0_xyz[1] * wedge_g4[3], right_dual_g0_xyz[2] * wedge_g4[3]]) * Simd32x3::from(-1.0),
            // e423, e431, e412, e321
...
impl AntiRejectViaHorizonFrom<MultiVector> for Plane {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e41, e42, e43
            (right_dual_g2 * Simd32x3::from(wedge_g0_y)) + (right_dual_g4.yzx() * wedge_g4.zxy()) - (right_dual_g4.zxy() * wedge_g4.yzx()),
            // e23, e31, e12
            (Simd32x3::from(right_dual_g4[3]) * wedge_g4.xyz()) - (Simd32x3::from(wedge_g4[3]) * right_dual_g4.xyz()),
            // e423, e431, e412, e321
            (right_dual_g4 * Simd32x4::from(wedge_g0_y)) + (wedge_g4 * Simd32x4::from(other[scalar])),
...
impl AntiRejectViaHorizonFrom<Point> for Point {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                right_dual_g0_xyz[2] * wedge_g1[1],
                right_dual_g0_xyz[0] * wedge_g1[2],
                right_dual_g0_xyz[1] * wedge_g1[0],
                -(right_dual_g0_xyz[1] * wedge_g0[1]) - (right_dual_g0_xyz[2] * wedge_g0[2]),
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                - (wedge_g3.zxy() * right_dual_g4.yzx()).with_w(right_dual_g2[0] * wedge_g4[0]),
            // e41, e42, e43
            (right_dual_g2 * Simd32x3::from(wedge_g0[1])) + (wedge_g2 * Simd32x3::from(other[scalar])) + (right_dual_g4.yzx() * wedge_g4.zxy())
                - (right_dual_g4.zxy() * wedge_g4.yzx()),
            // e23, e31, e12
            (wedge_g3 * Simd32x3::from(other[scalar])) + (Simd32x3::from(right_dual_g4[3]) * wedge_g4.xyz()) - (Simd32x3::from(wedge_g4[3]) * right_dual_g4.xyz()),
            // e423, e431, e412, e321
