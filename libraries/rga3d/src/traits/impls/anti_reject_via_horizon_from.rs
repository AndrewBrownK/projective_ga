...
impl AntiRejectViaHorizonFrom<Motor> for AntiScalar {
    ...
    fn anti_reject_via_horizon_from(self, other: Motor) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(self[e1234] * other[scalar]) * other.group1() * Simd32x4::from([-1.0, -1.0, -1.0, 1.0]),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        )
    }
...
impl AntiRejectViaHorizonFrom<Flector> for DualNum {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            ((right_dual_g1_xyz.yzx() * wedge_g1.zxy()) - (right_dual_g1_xyz.zxy() * wedge_g1.yzx())).with_w(0.0),
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_dual_g1_xyz[0] * wedge_g1[3] * -1.0,
                right_dual_g1_xyz[1] * wedge_g1[3] * -1.0,
                right_dual_g1_xyz[2] * wedge_g1[3] * -1.0,
                (right_dual_g1_xyz[0] * wedge_g0[0]) + (right_dual_g1_xyz[1] * wedge_g0[1]) + (right_dual_g1_xyz[2] * wedge_g0[2]) + (wedge_g1[3] * other[e321]),
            ]),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<MultiVector> for DualNum {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (right_dual_g4[0] * wedge_g1[0])
                    + (right_dual_g4[1] * wedge_g1[1])
                    + (right_dual_g4[2] * wedge_g1[2])
                    + (right_dual_g4[3] * wedge_g1[3])
            ...
            (right_dual_g1 * Simd32x4::from(wedge_g0_y))
                ...
                + Simd32x3::from(0.0).with_w(
                    -(right_dual_g2[0] * wedge_g4[0])
                        - (right_dual_g2[1] * wedge_g4[1])
                        - (right_dual_g2[2] * wedge_g4[2])
                        - (wedge_g2[1] * right_dual_g4[1])
                        - (wedge_g2[2] * right_dual_g4[2]),
                )
                + (right_dual_g2 * Simd32x3::from(wedge_g4[3])).with_w(0.0)
                + (wedge_g2 * Simd32x3::from(right_dual_g4[3])).with_w(0.0)
                + (wedge_g3.yzx() * right_dual_g4.zxy()).with_w(0.0)
                - (right_dual_g4.yzxx() * wedge_g3.zxy().with_w(wedge_g2[0])),
            // e41, e42, e43
            (right_dual_g2 * Simd32x3::from(wedge_g0_y))
                + (wedge_g2 * Simd32x3::from(other[scalar]))
                + Simd32x2::from(0.0).with_z((right_dual_g4[0] * wedge_g4[1]) - (right_dual_g4[1] * wedge_g4[0]))
                + (right_dual_g4.yz() * wedge_g4.zx()).with_z(0.0)
                - (right_dual_g4.zx() * wedge_g4.yz()).with_z(0.0),
            // e23, e31, e12
            (wedge_g3 * Simd32x3::from(other[scalar])) + (Simd32x3::from(right_dual_g4[3]) * wedge_g4.xyz()) - (Simd32x3::from(wedge_g4[3]) * right_dual_g4.xyz()),
            // e423, e431, e412, e321
            (right_dual_g4 * Simd32x4::from(wedge_g0_y)) + (wedge_g4 * Simd32x4::from(other[scalar])),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Point> for DualNum {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Scalar::from_groups(
            // scalar
            (right_dual_g0_xyz[0] * wedge_g0[0]) + (right_dual_g0_xyz[1] * wedge_g0[1]) + (right_dual_g0_xyz[2] * wedge_g0[2]),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Flector> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(-(right_dual_g1_xyz[1] * wedge_g0[1]) - (right_dual_g1_xyz[2] * wedge_g0[2]) - (wedge_g0[3] * other[e321]))
                + (right_dual_g1_xyz.zxy() * wedge_g1_xyz.yzx()).with_w(0.0)
                - (right_dual_g1_xyz.yzx() * wedge_g1_xyz.zxy()).with_w(right_dual_g1_xyz[0] * wedge_g0[0]),
            // e423, e431, e412, e321
            (right_dual_g1_xyz * Simd32x3::from(wedge_g0[3])).with_w(0.0),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Line> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Line) -> Self::Output {
        use crate::elements::*;
        let wedge_g0 = Simd32x3::from(0.0).with_w(-(self[e2] * other[e31]) - (self[e3] * other[e12]))
...
impl AntiRejectViaHorizonFrom<Motor> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Motor) -> Self::Output {
        ...
        let wedge_g1 = (other.group1() * Simd32x3::from(self[e4]).with_w(self[e321]))
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            (right_dual_g0 * Simd32x3::from(wedge_g1[3]).with_w(wedge_g0[3]))
                + Simd32x3::from(0.0).with_w(-(right_dual_g0[0] * wedge_g1[0]) - (right_dual_g0[1] * wedge_g1[1]) - (right_dual_g0[2] * wedge_g1[2]))
                + (Simd32x3::from(right_dual_g0[3]) * wedge_g0.xyz()).with_w(0.0),
            // e423, e431, e412, e321
...
impl AntiRejectViaHorizonFrom<MultiVector> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        let wedge_g4 = (Simd32x4::from(other[scalar]) * self.group1())
            + Simd32x3::from(0.0).with_w(-(self[e2] * other[e31]) - (self[e3] * other[e12]))
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (right_dual_g4[0] * wedge_g1[0]) + (right_dual_g4[1] * wedge_g1[1]) + (right_dual_g4[2] * wedge_g1[2]) + (right_dual_g4[3] * wedge_g1[3])
                    - (right_dual_g2[0] * wedge_g3[0])
                    - (right_dual_g2[1] * wedge_g3[1])
                    - (right_dual_g2[2] * wedge_g3[2])
                    - (right_dual_g1[0] * wedge_g4[0])
...
impl AntiRejectViaHorizonFrom<Point> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let wedge_g0 = Simd32x3::from(0.0).with_w(-(self[e423] * other[e1]) - (self[e431] * other[e2]) - (self[e412] * other[e3]))
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(-(right_dual_g0_xyz[1] * wedge_g0[1]) - (right_dual_g0_xyz[2] * wedge_g0[2])) + (right_dual_g0_xyz.zxy() * wedge_g1_xyz.yzx()).with_w(0.0)
                - (right_dual_g0_xyz.yzx() * wedge_g1_xyz.zxy()).with_w(right_dual_g0_xyz[0] * wedge_g0[0]),
            // e423, e431, e412, e321
            (right_dual_g0_xyz * Simd32x3::from(wedge_g0[3])).with_w(0.0),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<MultiVector> for Horizon {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (right_dual_g1 * Simd32x4::from(wedge_g0_y))
                + Simd32x3::from(0.0).with_w(-(right_dual_g2[0] * wedge_g4[0]) - (right_dual_g2[1] * wedge_g4[1]) - (right_dual_g2[2] * wedge_g4[2]))
                + (right_dual_g2 * Simd32x3::from(wedge_g4[3])).with_w(0.0),
            // e41, e42, e43
            (right_dual_g2 * Simd32x3::from(wedge_g0_y))
                + Simd32x2::from(0.0).with_z((right_dual_g4[0] * wedge_g4[1]) - (right_dual_g4[1] * wedge_g4[0]))
                ...
                - (right_dual_g4.zx() * wedge_g4.yz()).with_z(0.0),
            // e23, e31, e12
            (Simd32x3::from(right_dual_g4[3]) * wedge_g4.xyz()) - (Simd32x3::from(wedge_g4[3]) * right_dual_g4.xyz()),
            // e423, e431, e412, e321
            (right_dual_g4 * Simd32x4::from(wedge_g0_y)) + (wedge_g4 * Simd32x4::from(other[scalar])),
        )
    }
...
impl AntiRejectViaHorizonFrom<Flector> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        use crate::elements::*;
        let wedge_g0 = Simd32x3::from(0.0).with_w(-(other[e2] * self[e31]) - (other[e3] * self[e12]))
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            ((right_dual_g1_xyz.yzx() * wedge_g0.zxy()) - (right_dual_g1_xyz.zxy() * wedge_g0.yzx())).with_w(0.0),
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_dual_g1_xyz[0] * wedge_g0[3] * -1.0,
                right_dual_g1_xyz[1] * wedge_g0[3] * -1.0,
                right_dual_g1_xyz[2] * wedge_g0[3] * -1.0,
                wedge_g0[3] * other[e321],
            ]),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<MultiVector> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        let wedge_g4 = Simd32x3::from(0.0).with_w(-(self[e31] * other[e2]) - (self[e12] * other[e3]))
            + (Simd32x3::from(other[e4]) * self.group1()).with_w(0.0)
...
impl AntiRejectViaHorizonFrom<Point> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let wedge_g0 = Simd32x3::from(0.0).with_w(-(self[e31] * other[e2]) - (self[e12] * other[e3]))
            + (Simd32x3::from(other[e4]) * self.group1()).with_w(0.0)
            + (self.group0().yzx() * other.group0().zxy()).with_w(0.0)
            - (Simd32x4::from([self[e43], self[e41], self[e42], self[e23]]) * other.group0().yzxx());
        let right_dual_g0_xyz = other.group0().xyz();
        Line::from_groups(
            // e41, e42, e43
            (right_dual_g0_xyz.yzx() * wedge_g0.zxy()) - (right_dual_g0_xyz.zxy() * wedge_g0.yzx()),
            // e23, e31, e12
            Simd32x3::from([
                right_dual_g0_xyz[0] * wedge_g0[3] * -1.0,
                right_dual_g0_xyz[1] * wedge_g0[3] * -1.0,
                right_dual_g0_xyz[2] * wedge_g0[3] * -1.0,
            ]),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<DualNum> for Motor {
    ...
    fn anti_reject_via_horizon_from(self, other: DualNum) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x3::from(other[scalar]) * (Simd32x2::from(other[scalar]) * self.group0().xy()).with_z(other[scalar] * self[e43]))
...
impl AntiRejectViaHorizonFrom<Flector> for Motor {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        use crate::elements::*;
        let wedge_g0 = Simd32x4::from(self[scalar]) * other.group0();
        let wedge_g1 = (self.group1() * Simd32x3::from(other[e4]).with_w(other[e321]))
...
impl AntiRejectViaHorizonFrom<MultiVector> for Motor {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        let wedge_g4 = (self.group1() * Simd32x3::from(other[e4]).with_w(other[e321]))
...
impl AntiRejectViaHorizonFrom<Point> for Motor {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let wedge_g0 = Simd32x4::from(self[scalar]) * other.group0();
        let wedge_g1 = Simd32x3::from(0.0).with_w(-(self[e31] * other[e2]) - (self[e12] * other[e3]))
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            ((right_dual_g0_xyz.yzx() * wedge_g1.zxy()) - (right_dual_g0_xyz.zxy() * wedge_g1.yzx())).with_w(0.0),
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_dual_g0_xyz[0] * wedge_g1[3] * -1.0,
                right_dual_g0_xyz[1] * wedge_g1[3] * -1.0,
                right_dual_g0_xyz[2] * wedge_g1[3] * -1.0,
                (right_dual_g0_xyz[0] * wedge_g0[0]) + (right_dual_g0_xyz[1] * wedge_g0[1]) + (right_dual_g0_xyz[2] * wedge_g0[2]),
            ]),
        )
    }
...
impl AntiRejectViaHorizonFrom<Flector> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        let wedge_g4 = (Simd32x4::from(self[scalar]) * other.group1())
            + Simd32x3::from(0.0).with_w(-(other[e2] * self[e31]) - (other[e3] * self[e12]))
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (right_dual_g1_xyz[0] * wedge_g1[0]) + (right_dual_g1_xyz[1] * wedge_g1[1]) + (right_dual_g1_xyz[2] * wedge_g1[2])
            ...
            (right_dual_g0 * Simd32x4::from(wedge_g0_y))
                + Simd32x3::from(0.0).with_w(-(right_dual_g1_xyz[1] * wedge_g2[1]) - (right_dual_g1_xyz[2] * wedge_g2[2]))
                + (right_dual_g1_xyz.zxy() * wedge_g3.yzx()).with_w(0.0)
                - (right_dual_g1_xyz.yzx() * wedge_g3.zxy()).with_w(right_dual_g1_xyz[0] * wedge_g2[0]),
            // e41, e42, e43
            (right_dual_g1_xyz.yzx() * wedge_g4.zxy()) - (right_dual_g1_xyz.zxy() * wedge_g4.yzx()),
            // e23, e31, e12
            Simd32x3::from([
                right_dual_g1_xyz[0] * wedge_g4[3] * -1.0,
                right_dual_g1_xyz[1] * wedge_g4[3] * -1.0,
                right_dual_g1_xyz[2] * wedge_g4[3] * -1.0,
            ]),
            // e423, e431, e412, e321
            (right_dual_g1_xyz * Simd32x3::from(wedge_g0_y)).with_w(0.0),
        )
    }
}
impl AntiRejectViaHorizonFrom<Horizon> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Horizon) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([right_dual_g0 * other[e321] * self[scalar] * -1.0, 0.0]),
            // e1, e2, e3, e4
...
impl AntiRejectViaHorizonFrom<Line> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Line) -> Self::Output {
        ...
        let wedge_g4 = Simd32x3::from(0.0).with_w(-(other[e31] * self[e2]) - (other[e12] * self[e3]))
            + (Simd32x3::from(self[e4]) * other.group1()).with_w(0.0)
...
impl AntiRejectViaHorizonFrom<Motor> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Motor) -> Self::Output {
        ...
        let wedge_g4 = (other.group1() * Simd32x3::from(self[e4]).with_w(self[e321]))
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (right_dual_g0 * Simd32x3::from(wedge_g4[3]).with_w(wedge_g1[3]))
                + Simd32x3::from(0.0).with_w(-(right_dual_g0[0] * wedge_g4[0]) - (right_dual_g0[1] * wedge_g4[1]) - (right_dual_g0[2] * wedge_g4[2]))
                + (Simd32x3::from(right_dual_g0[3]) * wedge_g1.xyz()).with_w(0.0),
            // e41, e42, e43
...
impl AntiRejectViaHorizonFrom<MultiVector> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        let wedge_g3 = (Simd32x3::from(other[scalar]) * self.group3())
...
impl AntiRejectViaHorizonFrom<Point> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([(right_dual_g0_xyz[0] * wedge_g1[0]) + (right_dual_g0_xyz[1] * wedge_g1[1]) + (right_dual_g0_xyz[2] * wedge_g1[2]), 0.0]),
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(-(right_dual_g0_xyz[1] * wedge_g2[1]) - (right_dual_g0_xyz[2] * wedge_g2[2])) + (right_dual_g0_xyz.zxy() * wedge_g3.yzx()).with_w(0.0)
                - (right_dual_g0_xyz.yzx() * wedge_g3.zxy()).with_w(right_dual_g0_xyz[0] * wedge_g2[0]),
            // e41, e42, e43
            (right_dual_g0_xyz.yzx() * wedge_g4.zxy()) - (right_dual_g0_xyz.zxy() * wedge_g4.yzx()),
            // e23, e31, e12
            Simd32x3::from([
                right_dual_g0_xyz[0] * wedge_g4[3] * -1.0,
                right_dual_g0_xyz[1] * wedge_g4[3] * -1.0,
                right_dual_g0_xyz[2] * wedge_g4[3] * -1.0,
            ]),
            // e423, e431, e412, e321
...
impl AntiRejectViaHorizonFrom<Flector> for Origin {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0)
                .with_w(-(right_dual_g1_xyz[0] * wedge_g0[0]) - (right_dual_g1_xyz[1] * wedge_g0[1]) - (right_dual_g1_xyz[2] * wedge_g0[2]) - (wedge_g0[3] * other[e321])),
            // e423, e431, e412, e321
            (right_dual_g1_xyz * Simd32x3::from(wedge_g0[3])).with_w(0.0),
        )
    }
        ...
        MultiVector::from_groups(
            ...
            Simd32x3::from(0.0).with_w(
                (other[scalar] * other[scalar] * self[e4])
                    ...
                    - (right_dual_g4_xyz[0] * wedge_g2[0])
                    - (right_dual_g4_xyz[1] * wedge_g2[1])
                    - (right_dual_g4_xyz[2] * wedge_g2[2]),
            ),
            // e41, e42, e43
            (right_dual_g2 * Simd32x3::from(wedge_g0_y)) + (wedge_g2 * Simd32x3::from(other[scalar])) + (right_dual_g4_xyz.yzx() * wedge_g4_xyz.zxy())
                - (right_dual_g4_xyz.zxy() * wedge_g4_xyz.yzx()),
            // e23, e31, e12
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            ((right_dual_g4_xyz * Simd32x3::from(wedge_g0_y)) + (wedge_g4_xyz * Simd32x3::from(other[scalar]))).with_w(0.0),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Motor> for Plane {
    ...
    fn anti_reject_via_horizon_from(self, other: Motor) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            (Simd32x3::from(wedge_g0[3] * -1.0) * other.group1().xyz()).with_w((wedge_g0[0] * other[e23]) + (wedge_g0[1] * other[e31]) + (wedge_g0[2] * other[e12])),
            // e423, e431, e412, e321
...
impl AntiRejectViaHorizonFrom<Line> for Point {
    ...
    fn anti_reject_via_horizon_from(self, other: Line) -> Self::Output {
        use crate::elements::*;
        let wedge_g0 = Simd32x3::from(0.0).with_w(-(other[e31] * self[e2]) - (other[e12] * self[e3]))
            + (Simd32x3::from(self[e4]) * other.group1()).with_w(0.0)
            + (other.group0().yzx() * self.group0().zxy()).with_w(0.0)
            - (Simd32x4::from([other[e43], other[e41], other[e42], other[e23]]) * self.group0().yzxx());
        let right_dual_g0 = other.group1() * Simd32x3::from(-1.0);
...
impl AntiRejectViaHorizonFrom<Motor> for Point {
    ...
    fn anti_reject_via_horizon_from(self, other: Motor) -> Self::Output {
        use crate::elements::*;
        let wedge_g0 = Simd32x4::from(other[scalar]) * self.group0();
        let wedge_g1 = Simd32x3::from(0.0).with_w(-(other[e31] * self[e2]) - (other[e12] * self[e3]))
...
impl AntiRejectViaHorizonFrom<Point> for Point {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Point::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(-(right_dual_g0_xyz[1] * wedge_g0[1]) - (right_dual_g0_xyz[2] * wedge_g0[2])) + (right_dual_g0_xyz.zxy() * wedge_g1.yzx()).with_w(0.0)
                - (right_dual_g0_xyz.yzx() * wedge_g1.zxy()).with_w(right_dual_g0_xyz[0] * wedge_g0[0]),
        )
    }
}
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            (right_dual_g1 * Simd32x4::from(wedge_g0[1]))
                ...
                - (right_dual_g4.yzxx() * wedge_g3.zxy().with_w(wedge_g2[0])),
            // e41, e42, e43
            (right_dual_g2 * Simd32x3::from(wedge_g0[1]))
                + (wedge_g2 * Simd32x3::from(other[scalar]))
                + Simd32x2::from(0.0).with_z((right_dual_g4[0] * wedge_g4[1]) - (right_dual_g4[1] * wedge_g4[0]))
                + (right_dual_g4.yz() * wedge_g4.zx()).with_z(0.0)
                - (right_dual_g4.zx() * wedge_g4.yz()).with_z(0.0),
            ...
            (wedge_g3 * Simd32x3::from(other[scalar])) + (Simd32x3::from(right_dual_g4[3]) * wedge_g4.xyz()) - (Simd32x3::from(wedge_g4[3]) * right_dual_g4.xyz()),
            // e423, e431, e412, e321
            (right_dual_g4 * Simd32x4::from(wedge_g0[1])) + (wedge_g4 * Simd32x4::from(other[scalar])),
        )
    }
}
