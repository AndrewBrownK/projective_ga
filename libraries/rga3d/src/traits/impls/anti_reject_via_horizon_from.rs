...
impl AntiRejectViaHorizonFrom<Flector> for DualNum {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            (right_dual_g1_xyz * Simd32x4::from(wedge_g1[3]).xyz() * Simd32x3::from(-1.0)).with_w((wedge_g1[3] * other[e321]) + (self[scalar] * right_dual_g1_xyz[0] * other[e1])),
        )
    }
}
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            (right_dual_g1 * Simd32x4::from(wedge_g0_y))
                ...
                + ((right_dual_g2 * Simd32x3::from(wedge_g4[3])) + (wedge_g2 * Simd32x3::from(right_dual_g4[3])) + (wedge_g3.yzx() * right_dual_g4.zxy())
                    - (wedge_g3.zxy() * right_dual_g4.yzx()))
                .with_w(0.0),
            // e41, e42, e43
            Simd32x3::from([
                (right_dual_g4[1] * wedge_g4[2]) - (right_dual_g4[2] * wedge_g4[1]),
                (right_dual_g4[2] * wedge_g4[0]) - (right_dual_g4[0] * wedge_g4[2]),
                (right_dual_g4[0] * wedge_g4[1]) - (right_dual_g4[1] * wedge_g4[0]),
...
impl AntiRejectViaHorizonFrom<Flector> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            ((right_dual_g1_xyz.zxy() * wedge_g1.yzx()) - (right_dual_g1_xyz.yzx() * wedge_g1.zxy())).with_w(wedge_g0[3] * other[e321] * -1.0),
            // e423, e431, e412, e321
            (right_dual_g1_xyz * Simd32x4::from(wedge_g0[3]).xyz()).with_w(0.0),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Point> for Flector {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            ((right_dual_g0_xyz.zxy() * wedge_g1.yzx()) - (right_dual_g0_xyz.yzx() * wedge_g1.zxy())).with_w(0.0),
            // e423, e431, e412, e321
            (right_dual_g0_xyz * Simd32x4::from(self[e321]).xyz() * Simd32x4::from(other[e4]).xyz() * Simd32x3::from(-1.0)).with_w(0.0),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<MultiVector> for Horizon {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([right_dual_g1_w * wedge_g4[3] * -1.0, wedge_g0_y * other[scalar]]),
            // e1, e2, e3, e4
            (right_dual_g2 * Simd32x4::from(wedge_g4[3]).xyz()).with_w(right_dual_g1_w * wedge_g0_y),
            // e41, e42, e43
            Simd32x3::from([
                (right_dual_g4[1] * wedge_g4[2]) - (right_dual_g4[2] * wedge_g4[1]),
                (right_dual_g4[2] * wedge_g4[0]) - (right_dual_g4[0] * wedge_g4[2]),
...
impl AntiRejectViaHorizonFrom<Flector> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            ((right_dual_g1_xyz.yzx() * wedge_g0_xyz.zxy()) - (right_dual_g1_xyz.zxy() * wedge_g0_xyz.yzx())).with_w(0.0),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        )
    }
...
impl AntiRejectViaHorizonFrom<MultiVector> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: MultiVector) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                -(right_dual_g1_w * wedge_g4[3]) - (right_dual_g2[0] * wedge_g3[0]) - (right_dual_g2[1] * wedge_g3[1]) - (right_dual_g2[2] * wedge_g3[2]),
                wedge_g0_y * other[scalar],
            ]),
            // e1, e2, e3, e4
            ((right_dual_g2 * Simd32x3::from(wedge_g4[3])) + (wedge_g2 * Simd32x3::from(right_dual_g4[3])) + (wedge_g3.yzx() * right_dual_g4.zxy())
                - (wedge_g3.zxy() * right_dual_g4.yzx()))
            .with_w(right_dual_g1_w * wedge_g0_y),
            // e41, e42, e43
            Simd32x3::from([
                (right_dual_g4[1] * wedge_g4[2]) - (right_dual_g4[2] * wedge_g4[1]),
                (right_dual_g4[2] * wedge_g4[0]) - (right_dual_g4[0] * wedge_g4[2]),
...
impl AntiRejectViaHorizonFrom<Point> for Line {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Line::from_groups(
            // e41, e42, e43
            (right_dual_g0_xyz.yzx() * wedge_g0_xyz.zxy()) - (right_dual_g0_xyz.zxy() * wedge_g0_xyz.yzx()),
            // e23, e31, e12
            Simd32x3::from(0.0),
        )
    }
...
impl AntiRejectViaHorizonFrom<Flector> for Motor {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            // e41, e42, e43, e1234
            ((right_dual_g1_xyz.yzx() * wedge_g1_xyz.zxy()) - (right_dual_g1_xyz.zxy() * wedge_g1_xyz.yzx())).with_w(0.0),
            // e23, e31, e12, scalar
            (right_dual_g1_xyz * Simd32x3::from(wedge_g1_w * -1.0)).with_w((wedge_g1_w * other[e321]) + (right_dual_g1_xyz[0] * other[e1] * self[scalar])),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Point> for Motor {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            (right_dual_g0_xyz * Simd32x4::from(wedge_g1[3]).xyz() * Simd32x3::from(-1.0)).with_w(right_dual_g0_xyz[0] * self[scalar] * other[e1]),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Flector> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (right_dual_g1_xyz[0] * wedge_g1[0]) + (right_dual_g1_xyz[1] * wedge_g1[1]) + (right_dual_g1_xyz[2] * wedge_g1[2]) - (right_dual_g0_w * wedge_g4_w),
                0.0,
            ]),
            // e1, e2, e3, e4
            ((right_dual_g1_xyz.zxy() * wedge_g3.yzx()) - (right_dual_g1_xyz.yzx() * wedge_g3.zxy())).with_w(right_dual_g0_w * wedge_g0_y),
            // e41, e42, e43
            (right_dual_g1_xyz.yzx() * wedge_g4_xyz.zxy()) - (right_dual_g1_xyz.zxy() * wedge_g4_xyz.yzx()),
            // e23, e31, e12
            right_dual_g1_xyz * Simd32x3::from(wedge_g4_w * -1.0),
            // e423, e431, e412, e321
...
impl AntiRejectViaHorizonFrom<Point> for MultiVector {
    ...
    fn anti_reject_via_horizon_from(self, other: Point) -> Self::Output {
        ...
        MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            ((right_dual_g0_xyz.zxy() * wedge_g3.yzx()) - (right_dual_g0_xyz.yzx() * wedge_g3.zxy())).with_w(0.0),
            // e41, e42, e43
            (right_dual_g0_xyz.yzx() * wedge_g4_xyz.zxy()) - (right_dual_g0_xyz.zxy() * wedge_g4_xyz.yzx()),
            // e23, e31, e12
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
...
impl AntiRejectViaHorizonFrom<Flector> for Point {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Flector::from_groups(
            // e1, e2, e3, e4
            ((right_dual_g1_xyz.zxy() * wedge_g1.yzx()) - (right_dual_g1_xyz.yzx() * wedge_g1.zxy())).with_w(wedge_g0_w * other[e321] * -1.0),
            // e423, e431, e412, e321
            (right_dual_g1_xyz * Simd32x3::from(wedge_g0_w)).with_w(0.0),
        )
    }
}
...
impl AntiRejectViaHorizonFrom<Flector> for Scalar {
    ...
    fn anti_reject_via_horizon_from(self, other: Flector) -> Self::Output {
        ...
        Motor::from_groups(
            ...
            ((right_dual_g1_xyz.yzx() * wedge_g1.zxy()) - (right_dual_g1_xyz.zxy() * wedge_g1.yzx())).with_w(0.0),
            // e23, e31, e12, scalar
            (right_dual_g1_xyz * Simd32x4::from(wedge_g1[3]).xyz() * Simd32x3::from(-1.0)).with_w((wedge_g1[3] * other[e321]) + (right_dual_g1_xyz[0] * other[e1] * self[scalar])),
        )
    }
}
