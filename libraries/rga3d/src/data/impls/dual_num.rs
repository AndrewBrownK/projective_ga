...
impl std::ops::Sub<AntiScalar> for DualNum {
    ...
    fn sub(self, other: AntiScalar) -> Self::Output {
        use crate::elements::*;
        DualNum::from_groups(/* scalar, e1234 */ self.group0() + (Simd32x2::from([0.0, other[e1234]]) * Simd32x2::from([0.0, -1.0])))
    }
}
impl std::ops::SubAssign<AntiScalar> for DualNum {
    fn sub_assign(&mut self, other: AntiScalar) {
        use crate::elements::*;
        *self = DualNum::from_groups(/* scalar, e1234 */ self.group0() + (Simd32x2::from([0.0, other[e1234]]) * Simd32x2::from([0.0, -1.0])));
    }
}
...
impl std::ops::Sub<Scalar> for DualNum {
    ...
    fn sub(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        DualNum::from_groups(/* scalar, e1234 */ self.group0() + (Simd32x2::from([other[scalar], 0.0]) * Simd32x2::from([-1.0, 0.0])))
    }
}
impl std::ops::SubAssign<Scalar> for DualNum {
    fn sub_assign(&mut self, other: Scalar) {
        use crate::elements::*;
        *self = DualNum::from_groups(/* scalar, e1234 */ self.group0() + (Simd32x2::from([other[scalar], 0.0]) * Simd32x2::from([-1.0, 0.0])));
    }
}
